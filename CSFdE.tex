...
\end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ Slew Rate Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Slew Rate OpAmp};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Slew Rate OpAmp}{Slew Rate OpAmp}}
    \end{tikzpicture}
