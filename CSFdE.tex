...
\ctikzset{
    voltage/american font={\color{black}},
    bipole voltage style=american,
    color=black
}
\usepackage{graphicx}
...
\begin{multicols*}{3}
    ...
    \tikzset{
        ...
        every node/.append style={color=black}
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Prefissi SI (Notazione Scientifica)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Prefissi SI (Notazione Scientifica)}{Prefissi SI (Notazione Scientifica)}}{Prefissi SI (Notazione Scientifica)}}{Prefissi SI (Notazione Scientifica)}}{Prefissi SI (Notazione Scientifica)}}
    \end{tikzpicture}
    ...
    \resizebox{\columnwidth}{0.9\textheight}{%------------ Box 26 ---------------
        ...
        \begin{tikzpicture}
            ...
            %------------ Box 26 Header ---------------------
            \node[fancytitle, right=10pt] at (box.north west) {\color{white}Procedimento transitori:};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Procedimento transitori:}{Procedimento transitori:}}{Procedimento transitori:}}{Procedimento transitori:}}{Procedimento transitori:}}
        \end{tikzpicture}}
    ...
    \begin{tikzpicture}
        ...
        %------------ Box 27 Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Grafico};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Grafico}{Grafico}}{Grafico}}{Grafico}}{Grafico}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Condensatore - Carica/Scarica RC};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Condensatore - Carica/Scarica RC}{Condensatore - Carica/Scarica RC}}{Condensatore - Carica/Scarica RC}}{Condensatore - Carica/Scarica RC}}{Condensatore - Carica/Scarica RC}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        %------------ Box 4 Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Resistenze e Alimentazioni};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Resistenze e Alimentazioni}{Resistenze e Alimentazioni}}{Resistenze e Alimentazioni}}{Resistenze e Alimentazioni}}{Resistenze e Alimentazioni}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \vspace{0.2cm}
                \begin{center}
                    \begin{circuitikz}[scale=0.9, color=black]
                        % Diodo ON
                ...
                \vspace{0.2cm}
                \begin{center}
                    \begin{circuitikz}[scale=0.8, color=black]
                        % Conduzione diretta
                ...
                \begin{center}
                    \begin{circuitikz}[scale=0.7, color=black]
                        % Serie discordi
        ...
        %------------ Box 3 Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Diodi};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Diodi}{Diodi}}{Diodi}}{Diodi}}{Diodi}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Diodi - Esercizio Tipico (1/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Diodi - Esercizio Tipico (1/2)}{Diodi - Esercizio Tipico (1/2)}}{Diodi - Esercizio Tipico (1/2)}}{Diodi - Esercizio Tipico (1/2)}}{Diodi - Esercizio Tipico (1/2)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Diodi - Esercizio Tipico (2/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Diodi - Esercizio Tipico (2/2)}{Diodi - Esercizio Tipico (2/2)}}{Diodi - Esercizio Tipico (2/2)}}{Diodi - Esercizio Tipico (2/2)}}{Diodi - Esercizio Tipico (2/2)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Diodo + Condensatore};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Diodo + Condensatore}{Diodo + Condensatore}}{Diodo + Condensatore}}{Diodo + Condensatore}}{Diodo + Condensatore}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Raddrizzatore Singola Semionda};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Raddrizzatore Singola Semionda}{Raddrizzatore Singola Semionda}}{Raddrizzatore Singola Semionda}}{Raddrizzatore Singola Semionda}}{Raddrizzatore Singola Semionda}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Rilevatore di Picco};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Rilevatore di Picco}{Rilevatore di Picco}}{Rilevatore di Picco}}{Rilevatore di Picco}}{Rilevatore di Picco}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Alimentatore DC};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Alimentatore DC}{Alimentatore DC}}{Alimentatore DC}}{Alimentatore DC}}{Alimentatore DC}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}RC + Diodo: Analisi STATICA};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{RC + Diodo: Analisi STATICA}{RC + Diodo: Analisi STATICA}}{RC + Diodo: Analisi STATICA}}{RC + Diodo: Analisi STATICA}}{RC + Diodo: Analisi STATICA}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}RC + Diodo: Analisi DINAMICA (1/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{RC + Diodo: Analisi DINAMICA (1/2)}{RC + Diodo: Analisi DINAMICA (1/2)}}{RC + Diodo: Analisi DINAMICA (1/2)}}{RC + Diodo: Analisi DINAMICA (1/2)}}{RC + Diodo: Analisi DINAMICA (1/2)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}RC + Diodo: Analisi DINAMICA (2/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{RC + Diodo: Analisi DINAMICA (2/2)}{RC + Diodo: Analisi DINAMICA (2/2)}}{RC + Diodo: Analisi DINAMICA (2/2)}}{RC + Diodo: Analisi DINAMICA (2/2)}}{RC + Diodo: Analisi DINAMICA (2/2)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{Potenza Media Dissipata da un Diodo}
                ...
                \colorbox{cyan!20}{\parbox{0.95\linewidth}{
                    \textbf{$\bigstar$ FORMULA GENERALE:}

                    \vspace{0.1cm}
                    $$\boxed{P_{m,diss} = V \cdot I_D}$$
                ...
                \colorbox{yellow!30}{\parbox{0.95\linewidth}{
                    \textbf{$\bigstar$ DIODO ZENER con segnale periodico:}

                    \vspace{0.1cm}
                    $$\boxed{P_{m,diss} = \frac{\Delta t_1}{T} V_{dir} \cdot I_D + \frac{\Delta t_2}{T} V_{zener} \cdot I_D}$$
                ...
                \vspace{0.05cm}
                • Il diodo dissipa potenza \textbf{solo quando conduce}

                \vspace{0.05cm}
                • Con segnale periodico: pesare la potenza con il \textbf{duty cycle}
                ...
                \colorbox{red!25}{\parbox{0.95\linewidth}{
                    \textbf{$\triangle$ Verifica CRITICA:}
                ...
                \vspace{0.1cm}
                \textit{Esempio TdE 3/11/23: calcolo con onda quadra}

            \end{minipage}
        };
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Potenza Dissipata - Diodo};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Potenza Dissipata - Diodo}{Potenza Dissipata - Diodo}}{Potenza Dissipata - Diodo}}{Potenza Dissipata - Diodo}}{Potenza Dissipata - Diodo}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                        ...
                        \begin{center}
                            \begin{circuitikz}[scale=0.55, color=black]
        ...
        %------------ Box 5 Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Capacità: Formule e Comportamento};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Capacità: Formule e Comportamento}{Capacità: Formule e Comportamento}}{Capacità: Formule e Comportamento}}{Capacità: Formule e Comportamento}}{Capacità: Formule e Comportamento}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \vspace{0.2cm}
                \begin{center}
                    \begin{tikzpicture}[scale=0.6, color=black]
                        % Segnale di ingresso
        ...
        %------------ Box 6 Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Transitori con gradini multipli};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Transitori con gradini multipli}{Transitori con gradini multipli}}{Transitori con gradini multipli}}{Transitori con gradini multipli}}{Transitori con gradini multipli}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                        ...
                        \vspace{0.15cm}
                        \begin{center}
                            \begin{circuitikz}[scale=0.65, color=black]
        ...
        %------------ Box 7 Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Verifica ipotesi stato diodi};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Verifica ipotesi stato diodi}{Verifica ipotesi stato diodi}}{Verifica ipotesi stato diodi}}{Verifica ipotesi stato diodi}}{Verifica ipotesi stato diodi}}
    \end{tikzpicture}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \begin{center}
                    {\color{black}
                    \begin{circuitikz}[scale=1.0, color=black]
        ...
        %------------ Box 8 Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Notazione alimentazioni};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Notazione alimentazioni}{Notazione alimentazioni}}{Notazione alimentazioni}}{Notazione alimentazioni}}{Notazione alimentazioni}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \begin{center}
                    \begin{tikzpicture}[scale=0.8, color=black]
                        % Assi
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Onda Quadra Ideale - Guida al Disegno};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Onda Quadra Ideale - Guida al Disegno}{Onda Quadra Ideale - Guida al Disegno}}{Onda Quadra Ideale - Guida al Disegno}}{Onda Quadra Ideale - Guida al Disegno}}{Onda Quadra Ideale - Guida al Disegno}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Formazione del Canale nei MOSFET};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Formazione del Canale nei MOSFET}{Formazione del Canale nei MOSFET}}{Formazione del Canale nei MOSFET}}{Formazione del Canale nei MOSFET}}{Formazione del Canale nei MOSFET}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \begin{center}
                    \begin{circuitikz}[scale=2.0, color=black]
                        % nMOS symbol
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Simboli e convenzioni nMOS/pMOS};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Simboli e convenzioni nMOS/pMOS}{Simboli e convenzioni nMOS/pMOS}}{Simboli e convenzioni nMOS/pMOS}}{Simboli e convenzioni nMOS/pMOS}}{Simboli e convenzioni nMOS/pMOS}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \begin{center}
                    \begin{tikzpicture}[scale=0.9, color=black]
                        % Assi
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Caratteristica I-V nMOS};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Caratteristica I-V nMOS}{Caratteristica I-V nMOS}}{Caratteristica I-V nMOS}}{Caratteristica I-V nMOS}}{Caratteristica I-V nMOS}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Caratteristica I-V pMOS};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Caratteristica I-V pMOS}{Caratteristica I-V pMOS}}{Caratteristica I-V pMOS}}{Caratteristica I-V pMOS}}{Caratteristica I-V pMOS}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ Box nMOS Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}nMOS - Metodo operativo};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{nMOS - Metodo operativo}{nMOS - Metodo operativo}}{nMOS - Metodo operativo}}{nMOS - Metodo operativo}}{nMOS - Metodo operativo}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ Box pMOS Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}pMOS - Metodo operativo};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{pMOS - Metodo operativo}{pMOS - Metodo operativo}}{pMOS - Metodo operativo}}{pMOS - Metodo operativo}}{pMOS - Metodo operativo}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Riepilogo: nMOS vs pMOS};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Riepilogo: nMOS vs pMOS}{Riepilogo: nMOS vs pMOS}}{Riepilogo: nMOS vs pMOS}}{Riepilogo: nMOS vs pMOS}}{Riepilogo: nMOS vs pMOS}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}MOSFET simmetrici - Source e Drain a runtime};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{MOSFET simmetrici - Source e Drain a runtime}{MOSFET simmetrici - Source e Drain a runtime}}{MOSFET simmetrici - Source e Drain a runtime}}{MOSFET simmetrici - Source e Drain a runtime}}{MOSFET simmetrici - Source e Drain a runtime}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Regola pratica - MOSFET ON/OFF veloce};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Regola pratica - MOSFET ON/OFF veloce}{Regola pratica - MOSFET ON/OFF veloce}}{Regola pratica - MOSFET ON/OFF veloce}}{Regola pratica - MOSFET ON/OFF veloce}}{Regola pratica - MOSFET ON/OFF veloce}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ Overdrive Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Parametro K (Transconduttanza)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Parametro K (Transconduttanza)}{Parametro K (Transconduttanza)}}{Parametro K (Transconduttanza)}}{Parametro K (Transconduttanza)}}{Parametro K (Transconduttanza)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Semplificazioni MOSFET};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Semplificazioni MOSFET}{Semplificazioni MOSFET}}{Semplificazioni MOSFET}}{Semplificazioni MOSFET}}{Semplificazioni MOSFET}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Analisi Porte Logiche};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Analisi Porte Logiche}{Analisi Porte Logiche}}{Analisi Porte Logiche}}{Analisi Porte Logiche}}{Analisi Porte Logiche}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Resistenza di canale};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Resistenza di canale}{Resistenza di canale}}{Resistenza di canale}}{Resistenza di canale}}{Resistenza di canale}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Carica di un condensatore con MOSFET};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Carica di un condensatore con MOSFET}{Carica di un condensatore con MOSFET}}{Carica di un condensatore con MOSFET}}{Carica di un condensatore con MOSFET}}{Carica di un condensatore con MOSFET}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Scarica di un condensatore con MOSFET};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Scarica di un condensatore con MOSFET}{Scarica di un condensatore con MOSFET}}{Scarica di un condensatore con MOSFET}}{Scarica di un condensatore con MOSFET}}{Scarica di un condensatore con MOSFET}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Valutazione logica circuiti ibridi/intermedi (PTL)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Valutazione logica circuiti ibridi/intermedi (PTL)}{Valutazione logica circuiti ibridi/intermedi (PTL)}}{Valutazione logica circuiti ibridi/intermedi (PTL)}}{Valutazione logica circuiti ibridi/intermedi (PTL)}}{Valutazione logica circuiti ibridi/intermedi (PTL)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Tempo di propagazione};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Tempo di propagazione}{Tempo di propagazione}}{Tempo di propagazione}}{Tempo di propagazione}}{Tempo di propagazione}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ PTL vs CMOS Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}PTL vs CMOS Logic};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{PTL vs CMOS Logic}{PTL vs CMOS Logic}}{PTL vs CMOS Logic}}{PTL vs CMOS Logic}}{PTL vs CMOS Logic}}
    \end{tikzpicture}
    ...
    \textit{Nota:} Metodo 1 sovrastima il ritardo, Metodo 2 lo sottostima.
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Tempo di propagazione - PTL};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Tempo di propagazione - PTL}{Tempo di propagazione - PTL}}{Tempo di propagazione - PTL}}{Tempo di propagazione - PTL}}{Tempo di propagazione - PTL}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Riconoscere circuiti PTL};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Riconoscere circuiti PTL}{Riconoscere circuiti PTL}}{Riconoscere circuiti PTL}}{Riconoscere circuiti PTL}}{Riconoscere circuiti PTL}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Contention (CMOS) vs Limitazione (PTL)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Contention (CMOS) vs Limitazione (PTL)}{Contention (CMOS) vs Limitazione (PTL)}}{Contention (CMOS) vs Limitazione (PTL)}}{Contention (CMOS) vs Limitazione (PTL)}}{Contention (CMOS) vs Limitazione (PTL)}}
    \end{tikzpicture}
...
\begin{tikzpicture}
    ...
    \node[fancytitle, right=10pt] at (box.north west) {\color{white}Soglia Logica CMOS vs. PTL};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Soglia Logica CMOS vs. PTL}{Soglia Logica CMOS vs. PTL}}{Soglia Logica CMOS vs. PTL}}{Soglia Logica CMOS vs. PTL}}{Soglia Logica CMOS vs. PTL}}
\end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Tabella di Verità - Circuiti PTL};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Tabella di Verità - Circuiti PTL}{Tabella di Verità - Circuiti PTL}}{Tabella di Verità - Circuiti PTL}}{Tabella di Verità - Circuiti PTL}}{Tabella di Verità - Circuiti PTL}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Potenza statica};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Potenza statica}{Potenza statica}}{Potenza statica}}{Potenza statica}}{Potenza statica}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Potenza dinamica - Formula};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Potenza dinamica - Formula}{Potenza dinamica - Formula}}{Potenza dinamica - Formula}}{Potenza dinamica - Formula}}{Potenza dinamica - Formula}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Potenza dinamica - Calcolo da grafico};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Potenza dinamica - Calcolo da grafico}{Potenza dinamica - Calcolo da grafico}}{Potenza dinamica - Calcolo da grafico}}{Potenza dinamica - Calcolo da grafico}}{Potenza dinamica - Calcolo da grafico}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ Duty Cycle Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Duty Cycle};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Duty Cycle}{Duty Cycle}}{Duty Cycle}}{Duty Cycle}}{Duty Cycle}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{Prestazioni e Massima Frequenza di Commutazione}
                ...
                \vspace{0.15cm}
                \textbf{Prestazioni del Circuito:}

                \vspace{0.1cm}
                Il circuito funziona correttamente se:

                \vspace{0.05cm}
                $$\boxed{\tau_{prop} \le \frac{T_{in}}{2}}$$

                \vspace{0.05cm}
                Dove:
                \begin{itemize}[itemsep=0pt, leftmargin=*]
                    \item $\tau_{prop}$ = tempo di propagazione (tempo per raggiungere il regime)
                    \item $T_{in}$ = periodo del segnale di ingresso
                \end{itemize}

                \vspace{0.15cm}
                \textbf{Massima Frequenza di Commutazione:}

                \vspace{0.1cm}
                La frequenza massima a cui il circuito può commutare correttamente è:

                \vspace{0.05cm}
                $$\boxed{f_{max} = \frac{1}{2\tau_{prop}}}$$
                ...
                \vspace{0.05cm}
                • Se $f > f_{max}$: il circuito \textbf{NON ha tempo} di raggiungere il regime

                \vspace{0.05cm}
                • L'uscita non raggiunge i valori $V_{OH}$ / $V_{OL}$ completi

                \vspace{0.05cm}
                • Le formule di potenza dinamica \textbf{NON sono valide}

                \vspace{0.15cm}
                \footnotesize
                    \textbf{$\bigstar$ NOTA PRATICA}

                    \vspace{0.05cm}
                    • Queste formule si usano per verificare se il circuito può operare a una data frequenza

                    \vspace{0.05cm}
                    • Prima di calcolare $P_D$, controllare sempre: $\tau_{prop} \le \frac{T_{in}}{2}$

                    \vspace{0.05cm}
                    • Se hai calcolato solo $\tau_{prop}$ per una transizione (es. H$\to$L) e $K_n \approx K_p$, l'altra transizione ha tempo simile (stesso ordine di grandezza)

            \end{minipage}
        };
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Prestazioni e $f_{max}$};{Prestazioni e fmax}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ cMOS Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Porte cMOS - Definizione};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Porte cMOS - Definizione}{Porte cMOS - Definizione}}{Porte cMOS - Definizione}}{Porte cMOS - Definizione}}{Porte cMOS - Definizione}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \vspace{0.15cm}
                \colorbox{yellow!30}{\parbox{0.95\linewidth}{
                    \textbf{$\bigstar$ REGOLA MNEMONICA:}

                    \vspace{0.1cm}
                    • nMOS in \textbf{parallelo} $\Rightarrow$ funzione \textbf{OR}

                    \vspace{0.05cm}
                    • nMOS in \textbf{serie} $\Rightarrow$ funzione \textbf{AND}

                    \vspace{0.1cm}
                    \textit{Nota:} La negazione avviene ``naturalmente'' nella rete pull-down!

                    \vspace{0.05cm}
                    PDN implementa la funzione logica diretta, PUN implementa il complemento (per dualità).
                }}

            \end{minipage}
        };
        %------------ Costruzione PUN da PDN Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Costruzione PUN da PDN};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Costruzione PUN da PDN}{Costruzione PUN da PDN}}{Costruzione PUN da PDN}}{Costruzione PUN da PDN}}{Costruzione PUN da PDN}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{Invertitore nMOS con Carico Resistivo}
                ...
                \vspace{0.1cm}
                • \textbf{Ingresso HIGH} ($V_{in} = V_{DD}$):

                \hspace{0.3cm} -- nMOS ON (saturazione o ohmica)

                \hspace{0.3cm} -- Corrente scorre attraverso $R_L$ e nMOS

                \hspace{0.3cm} -- $V_{out} = V_{DD} - R_L \cdot I_D$ (basso, $\approx$ GND)

                \vspace{0.05cm}
                • \textbf{Ingresso LOW} ($V_{in} = 0$):

                \hspace{0.3cm} -- nMOS OFF

                \hspace{0.3cm} -- Nessuna corrente: $I_D = 0$

                \hspace{0.3cm} -- $V_{out} = V_{DD}$ (alto)

                \vspace{0.15cm}
                \textbf{Formula $V_{out}$ (nMOS ON):}

                \vspace{0.1cm}
                Equazione: $I_{R_L} = I_D$ (stessa corrente)
                ...
                • \textbf{Saturazione}: $I_D = K_n(V_{in} - V_T)^2$

                • \textbf{Ohmica}: $I_D = K_n[2(V_{in} - V_T)V_{out} - V_{out}^2]$

                \vspace{0.15cm}
                \footnotesize
                    \textbf{$\bigstar$ SVANTAGGIO rispetto al cMOS}

                    \vspace{0.05cm}
                    • Con nMOS ON: scorre corrente \textbf{statica} da $V_{DD}$ a GND
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Invertitore nMOS con $R_L$};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Invertitore nMOS con}{Invertitore nMOS con}}{Invertitore nMOS con}}{Invertitore nMOS con}}{Invertitore nMOS con RL}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture} 
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}GUIDA - Tabella di Verità Reti CMOS};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{GUIDA - Tabella di Verità Reti CMOS}{GUIDA - Tabella di Verità Reti CMOS}}{GUIDA - Tabella di Verità Reti CMOS}}{GUIDA - Tabella di Verità Reti CMOS}}{GUIDA - Tabella di Verità Reti CMOS}}
    \end{tikzpicture}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Livelli di Tensione e Soglia Logica};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Livelli di Tensione e Soglia Logica}{Livelli di Tensione e Soglia Logica}}{Livelli di Tensione e Soglia Logica}}{Livelli di Tensione e Soglia Logica}}{Livelli di Tensione e Soglia Logica}}
    \end{tikzpicture}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Riconoscere Rete cMOS Completa};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Riconoscere Rete cMOS Completa}{Riconoscere Rete cMOS Completa}}{Riconoscere Rete cMOS Completa}}{Riconoscere Rete cMOS Completa}}{Riconoscere Rete cMOS Completa}}
    \end{tikzpicture}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Complementare vs Non Complementare --- Cosa Fare};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Complementare vs Non Complementare --- Cosa Fare}{Complementare vs Non Complementare --- Cosa Fare}}{Complementare vs Non Complementare --- Cosa Fare}}{Complementare vs Non Complementare --- Cosa Fare}}{Complementare vs Non Complementare --- Cosa Fare}}
    \end{tikzpicture}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Contention PUN/PDN - Teoria};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Contention PUN/PDN - Teoria}{Contention PUN/PDN - Teoria}}{Contention PUN/PDN - Teoria}}{Contention PUN/PDN - Teoria}}{Contention PUN/PDN - Teoria}}
    \end{tikzpicture}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Contention PUN/PDN - Calcolo};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Contention PUN/PDN - Calcolo}{Contention PUN/PDN - Calcolo}}{Contention PUN/PDN - Calcolo}}{Contention PUN/PDN - Calcolo}}{Contention PUN/PDN - Calcolo}}
    \end{tikzpicture}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Soglia Logica della Porta ($V_M$)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Soglia Logica della Porta ()}{Soglia Logica della Porta ()}}{Soglia Logica della Porta ()}}{Soglia Logica della Porta ()}}{Soglia Logica della Porta ()}}
    \end{tikzpicture}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \vspace{0.1cm}
                \begin{center}
                    \begin{tikzpicture}[scale=0.55, color=black]
                        % Axes
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Introduzione e Caratteristica};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Introduzione e Caratteristica}{OpAmp - Introduzione e Caratteristica}}{OpAmp - Introduzione e Caratteristica}}{OpAmp - Introduzione e Caratteristica}}{OpAmp - Introduzione e Caratteristica}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Impedenza con Condensatori};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Impedenza con Condensatori}{Impedenza con Condensatori}}{Impedenza con Condensatori}}{Impedenza con Condensatori}}{Impedenza con Condensatori}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Forma Standard per Bode};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Forma Standard per Bode}{Forma Standard per Bode}}{Forma Standard per Bode}}{Forma Standard per Bode}}{Forma Standard per Bode}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ Bode Modulo Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Bode - Diagramma del Modulo};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Bode - Diagramma del Modulo}{Bode - Diagramma del Modulo}}{Bode - Diagramma del Modulo}}{Bode - Diagramma del Modulo}}{Bode - Diagramma del Modulo}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Bode - Metodo Generale Unificato};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Bode - Metodo Generale Unificato}{Bode - Metodo Generale Unificato}}{Bode - Metodo Generale Unificato}}{Bode - Metodo Generale Unificato}}{Bode - Metodo Generale Unificato}}
    \end{tikzpicture}}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \vspace{0.15cm}
                    ...
                    \textbf{Grafici per visualizzare le regole:}

                    \vspace{0.1cm}
                    \begin{center}
                    \begin{tabular}{cc}
                        % Grafico -20 dB/dec
                        \begin{tikzpicture}[scale=0.35, color=black]
                            \draw[->] (0,0) -- (5,0) node[right] {\tiny $f$};
                            \draw[->] (0,0) -- (0,4) node[above] {\tiny $G$};
                            \draw[thick, blue] (0.5,3.5) -- (4.5,0.5);
                            \draw[fill=red] (1,3) circle (2pt);
                            \draw[fill=red] (3,1.5) circle (2pt);
                            \node[above right] at (1,3) {\tiny $(f_1, G_1)$};
                            \node[below right] at (3,1.5) {\tiny $(f_2, G_2)$};
                            \node[below] at (2.5,-0.5) {\tiny $-20$ dB/dec};
                            \node[below, color=blue] at (2.5,-0.9) {\tiny $G_1 f_1 = G_2 f_2$};
                        \end{tikzpicture}
                        &
                        % Grafico +20 dB/dec
                        \begin{tikzpicture}[scale=0.35, color=black]
                            \draw[->] (0,0) -- (5,0) node[right] {\tiny $f$};
                            \draw[->] (0,0) -- (0,4) node[above] {\tiny $G$};
                            \draw[thick, blue] (0.5,0.5) -- (4.5,3.5);
                            \draw[fill=red] (1,1) circle (2pt);
                            \draw[fill=red] (3,2.5) circle (2pt);
                            \node[below right] at (1,1) {\tiny $(f_1, G_1)$};
                            \node[above right] at (3,2.5) {\tiny $(f_2, G_2)$};
                            \node[below] at (2.5,-0.5) {\tiny $+20$ dB/dec};
                            \node[below, color=blue] at (2.5,-0.9) {\tiny $\frac{G_1}{f_1} = \frac{G_2}{f_2}$};
                        \end{tikzpicture}
                        \\[0.3cm]
                        % Grafico -40 dB/dec
                        \begin{tikzpicture}[scale=0.35, color=black]
                            \draw[->] (0,0) -- (5,0) node[right] {\tiny $f$};
                            \draw[->] (0,0) -- (0,4) node[above] {\tiny $G$};
                            \draw[thick, blue, domain=0.7:4.5, samples=50] plot (\x, {4.5 - 1.8*(\x-0.7)});
                            \draw[fill=red] (1,3.96) circle (2pt);
                            \draw[fill=red] (2.5,1.26) circle (2pt);
                            \node[above right] at (1,3.96) {\tiny $(f_1, G_1)$};
                            \node[below right] at (2.5,1.26) {\tiny $(f_2, G_2)$};
                            \node[below] at (2.5,-0.5) {\tiny $-40$ dB/dec};
                            \node[below, color=blue] at (2.5,-0.9) {\tiny $G_1 f_1^2 = G_2 f_2^2$};
                        \end{tikzpicture}
                        &
                        % Grafico +40 dB/dec
                        \begin{tikzpicture}[scale=0.35, color=black]
                            \draw[->] (0,0) -- (5,0) node[right] {\tiny $f$};
                            \draw[->] (0,0) -- (0,4) node[above] {\tiny $G$};
                            \draw[thick, blue, domain=0.7:4.5, samples=50] plot (\x, {0.3 + 1.8*(\x-0.7)});
                            \draw[fill=red] (1,0.84) circle (2pt);
                            \draw[fill=red] (2.5,3.54) circle (2pt);
                            \node[below right] at (1,0.84) {\tiny $(f_1, G_1)$};
                            \node[above right] at (2.5,3.54) {\tiny $(f_2, G_2)$};
                            \node[below] at (2.5,-0.5) {\tiny $+40$ dB/dec};
                            \node[below, color=blue] at (2.5,-0.9) {\tiny $\frac{G_1}{f_1^2} = \frac{G_2}{f_2^2}$};
                        \end{tikzpicture}
                    \end{tabular}
                    \end{center}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Formule Rapide di Navigazione sul Bode};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Formule Rapide di Navigazione sul Bode}{Formule Rapide di Navigazione sul Bode}}{Formule Rapide di Navigazione sul Bode}}{Formule Rapide di Navigazione sul Bode}}{Formule Rapide di Navigazione sul Bode}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Bode - Singolarità in Zero ($n \neq 0$)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Bode - Singolarità in Zero ()}{Bode - Singolarità in Zero ()}}{Bode - Singolarità in Zero ()}}{Bode - Singolarità in Zero ()}}{Bode - Singolarità in Zero ()}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ Bode Fase Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Bode - Diagramma della Fase};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Bode - Diagramma della Fase}{Bode - Diagramma della Fase}}{Bode - Diagramma della Fase}}{Bode - Diagramma della Fase}}{Bode - Diagramma della Fase}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Intersezione 0 dB in Bode};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Intersezione 0 dB in Bode}{Intersezione 0 dB in Bode}}{Intersezione 0 dB in Bode}}{Intersezione 0 dB in Bode}}{Intersezione 0 dB in Bode}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Calcolo Guadagno a Frequenze Specifiche};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Calcolo Guadagno a Frequenze Specifiche}{Calcolo Guadagno a Frequenze Specifiche}}{Calcolo Guadagno a Frequenze Specifiche}}{Calcolo Guadagno a Frequenze Specifiche}}{Calcolo Guadagno a Frequenze Specifiche}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Bode - Polo e Zero Coincidenti};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Bode - Polo e Zero Coincidenti}{Bode - Polo e Zero Coincidenti}}{Bode - Polo e Zero Coincidenti}}{Bode - Polo e Zero Coincidenti}}{Bode - Polo e Zero Coincidenti}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Guadagno Reale vs Ideale};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Guadagno Reale vs Ideale}{Guadagno Reale vs Ideale}}{Guadagno Reale vs Ideale}}{Guadagno Reale vs Ideale}}{Guadagno Reale vs Ideale}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Guadagno Reale - Intersezioni};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Guadagno Reale - Intersezioni}{Guadagno Reale - Intersezioni}}{Guadagno Reale - Intersezioni}}{Guadagno Reale - Intersezioni}}{Guadagno Reale - Intersezioni}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Margine di Fase e Stabilit\`a};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Margine di Fase e Stabilit\`a}{Margine di Fase e Stabilit\`a}}{Margine di Fase e Stabilit\`a}}{Margine di Fase e Stabilit\`a}}{Margine di Fase e Stabilit\`a}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Stabilit\`a - Senza Crossover};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Stabilit\`a - Senza Crossover}{Stabilit\`a - Senza Crossover}}{Stabilit\`a - Senza Crossover}}{Stabilit\`a - Senza Crossover}}{Stabilit\`a - Senza Crossover}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Retroazione e Saturazione};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Retroazione e Saturazione}{OpAmp - Retroazione e Saturazione}}{OpAmp - Retroazione e Saturazione}}{OpAmp - Retroazione e Saturazione}}{OpAmp - Retroazione e Saturazione}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Riconoscere Configurazione};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Riconoscere Configurazione}{OpAmp - Riconoscere Configurazione}}{OpAmp - Riconoscere Configurazione}}{OpAmp - Riconoscere Configurazione}}{OpAmp - Riconoscere Configurazione}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Saturazione dell'Uscita};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Saturazione dell'Uscita}{OpAmp - Saturazione dell'Uscita}}{OpAmp - Saturazione dell'Uscita}}{OpAmp - Saturazione dell'Uscita}}{OpAmp - Saturazione dell'Uscita}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{OpAmp - Alimentazione Rail-to-Rail}
                ...
                \colorbox{cyan!20}{\parbox{0.95\linewidth}{
                    ...
                    \vspace{0.1cm}
                    $$\boxed{V_{out} \in [V_{ALIM}^-, V_{ALIM}^+]}$$

                    \vspace{0.05cm}
                    L'uscita può raggiungere (quasi) le tensioni di alimentazione.

                    \vspace{0.05cm}
                    \textit{(in realtà: piccolo offset di ~0.1-0.2V dalle rail)}
                }}

                \vspace{0.15cm}
                \textbf{Limiti su segnali sinusoidali:}

                \vspace{0.1cm}
                Con $V_{in} = A \sin(2\pi f_{in} t)$ e guadagno $G_{id} = \dfrac{R_2}{R_1}$ (o altro):

                \vspace{0.05cm}
                • $V_{out} = G_{id} \cdot V_{in}$ (sinusoidale idealmente)

                \vspace{0.05cm}
                • Ma: $V_{out}$ \textbf{clippato} se supera le alimentazioni!

                \vspace{0.05cm}
                • Ampiezza massima senza distorsione:

                $$\boxed{A_{max} = \frac{V_{ALIM}^+ - V_{ALIM}^-}{2 \cdot |G_{id}|}}$$

                \vspace{0.15cm}
                \colorbox{red!25}{\parbox{0.95\linewidth}{
                    \textbf{$\triangle$ Se supera: \textbf{distorsione} (clipping)!}
                ...
                \vspace{0.05cm}
                $A_{max} = \dfrac{5 - 0}{2 \cdot 10} = 0.25V = 250$ mV

                \vspace{0.05cm}
                Se $A > 250$ mV $\Rightarrow$ clipping!

            \end{minipage}
        };
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp Rail-to-Rail};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp Rail-to-Rail}{OpAmp Rail-to-Rail}}{OpAmp Rail-to-Rail}}{OpAmp Rail-to-Rail}}{OpAmp Rail-to-Rail}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \vspace{0.15cm}
                \begin{center}
                    \begin{tikzpicture}[scale=0.5, transform shape, color=black]
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Retroazione Negativa};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Retroazione Negativa}{OpAmp - Retroazione Negativa}}{OpAmp - Retroazione Negativa}}{OpAmp - Retroazione Negativa}}{OpAmp - Retroazione Negativa}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Riconoscimento Rapido};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Riconoscimento Rapido}{OpAmp - Riconoscimento Rapido}}{OpAmp - Riconoscimento Rapido}}{OpAmp - Riconoscimento Rapido}}{OpAmp - Riconoscimento Rapido}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{Tensione di Offset ($V_{OS}$):}

                \vspace{0.15cm}
                Differenza di tensione necessaria tra $V^+$ e $V^-$ per avere $V_{out} = 0$

                \vspace{0.15cm}
                \textbf{Condizioni di analisi:}

                \vspace{0.05cm}
                • Siamo in \textbf{corrente continua} $\Rightarrow$ condensatori aperti ($\to \infty$)

                \vspace{0.05cm}
                • L'OpAmp in analisi è \textbf{ideale}: $V^+ = V^-$ (retroazione negativa)
                ...
                \begin{enumerate}[leftmargin=*,itemsep=0pt]
                    \item Spegnere tutti i generatori d'ingresso
                    \item Aggiungere $V_{OS}$ a \textbf{uno dei due morsetti} (scegliere verso arbitrario)
                    \item Calcolare il contributo all'uscita:
                \end{enumerate}

                \vspace{0.1cm}
                $$\boxed{V_{out}\big|_{V_{OS}} = V_{OS} \cdot G_{ID}}$$
                ...
                \vspace{0.15cm}
                \footnotesize
                    \textbf{$\bigstar$ IMPORTANTE}

                    \vspace{0.05cm}
                    • Il verso di $V_{OS}$ è \textbf{arbitrario} $\Rightarrow$ l'effetto finale è \textbf{$\pm V_{OS} \cdot G_{ID}$}

                    \vspace{0.05cm}
                    • $V_{OS}$ è un contributo \textbf{statistico} con limite superiore e inferiore

                    \vspace{0.05cm}
                    • Il contributo si somma algebricamente con gli altri errori (sovrapposizione)


            \end{minipage}
        };
        %------------ Non idealità Offset Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Non idealità: Tensione di Offset};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Non idealità: Tensione di Offset}{OpAmp - Non idealità: Tensione di Offset}}{OpAmp - Non idealità: Tensione di Offset}}{OpAmp - Non idealità: Tensione di Offset}}{OpAmp - Non idealità: Tensione di Offset}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{Correnti di Bias ($I_B^+$ e $I_B^-$):}
                ...
                \vspace{0.15cm}
                \textbf{Rappresentazione nel circuito:}

                \vspace{0.1cm}
                I generatori di corrente $I_B^+$ e $I_B^-$ si collegano \textbf{esternamente ai nodi} $V^+$ e $V^-$

                \vspace{0.1cm}
                {\footnotesize\textit{(collegamento esterno evita confusione durante sovrapposizione effetti)}}

                \vspace{0.1cm}
                • Le correnti possono essere:

                \hspace{0.3cm} -- \textbf{Entranti} nell'OpAmp (verso $\downarrow$)

                \hspace{0.3cm} -- \textbf{Uscenti} dall'OpAmp (verso $\uparrow$)

                \vspace{0.15cm}
                \textbf{Algoritmo di calcolo:}

                \vspace{0.1cm}
                \begin{enumerate}[leftmargin=*,itemsep=0pt]
                    \item Spegnere tutti i generatori d'ingresso
                    \item Applicare \textbf{sovrapposizione degli effetti} tra $I_B^+$ e $I_B^-$
                    \item Calcolare i contributi separatamente:
                \end{enumerate}

                \vspace{0.1cm}
                $$V_{out}\big|_{I_B^+} \quad \text{e} \quad V_{out}\big|_{I_B^-}$$

                \vspace{0.05cm}
                $$\boxed{V_{out}\big|_{I_B} = V_{out}\big|_{I_B^+} + V_{out}\big|_{I_B^-}}$$

                \vspace{0.15cm}
                \footnotesize
                    \textbf{$\bigstar$ NOTE CRUCIALI}

                    \vspace{0.05cm}
                    • L'OpAmp resta ideale: $V^+ = V^-$ e $i^+ = i^- = 0$ \textbf{internamente}

                    \vspace{0.05cm}
                    • I generatori $I_B$ sono \textbf{esterni} ai nodi, quindi non violano $i^+ = i^- = 0$

                    \vspace{0.05cm}
                    • Collegando i generatori \textbf{esternamente}, posso applicare sovrapposizione senza ambiguità


            \end{minipage}
        };
        %------------ Non idealità Correnti Bias Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Non idealità: Correnti di Bias};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Non idealità: Correnti di Bias}{OpAmp - Non idealità: Correnti di Bias}}{OpAmp - Non idealità: Correnti di Bias}}{OpAmp - Non idealità: Correnti di Bias}}{OpAmp - Non idealità: Correnti di Bias}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{Correnti di Offset ($I_{OS}$):}

                \vspace{0.15cm}
                Contributo \textbf{statistico} alle correnti di bias (modellazione dell'incertezza)
                ...
                \vspace{0.1cm}
                Ogni morsetto ha un contributo pari a $\dfrac{I_{OS}}{2}$ con \textbf{versi opposti}:

                \vspace{0.05cm}
                • Su $V^+$: $+\dfrac{I_{OS}}{2}$ (verso arbitrario)

                • Su $V^-$: $-\dfrac{I_{OS}}{2}$ (verso opposto)

                \vspace{0.1cm}
                {\footnotesize I versi opposti modellano l'asimmetria tra i due ingressi}
                ...
                \vspace{0.1cm}
                $$\boxed{V_{out}\big|_{I_{OS}} = V_{out}\big|_{I_{OS}/2,\,V^+} + V_{out}\big|_{I_{OS}/2,\,V^-}}$$
                ...
                \footnotesize
                    ...
                    \vspace{0.05cm}
                    • $I_{OS}$ è un \textbf{contributo statistico} $\Rightarrow$ l'effetto ha limite sup. e inf.

                    \vspace{0.05cm}
                    • L'effetto finale è \textbf{$\pm$} (come $V_{OS}$)
        ...
        %------------ Non idealità Correnti Offset Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Non idealità: Correnti di Offset};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Non idealità: Correnti di Offset}{OpAmp - Non idealità: Correnti di Offset}}{OpAmp - Non idealità: Correnti di Offset}}{OpAmp - Non idealità: Correnti di Offset}}{OpAmp - Non idealità: Correnti di Offset}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \vspace{0.15cm}
                $$\boxed{\text{SR} = \frac{d}{dt}\left(V_{out,\,OpAmp}\right)\bigg|_{\text{MAX}}}$$

                \vspace{0.1cm}
                Unità: V/$\mu$s oppure V/s

                \vspace{0.15cm}
                \textbf{Verifica per sinusoidi:}

                \vspace{0.1cm}
                Per $V_{out}(t) = V_{\text{max}} \sin(\omega t)$:
                ...
                \vspace{0.05cm}
                $$\boxed{\left|\frac{dV_{out}}{dt}\right|_{\text{max}} = 2\pi f V_{\text{max}}}$$
                ...
                \footnotesize
                    ...
                    \vspace{0.05cm}
                    • SR è \textbf{indipendente dal guadagno} (caratteristica dell'OpAmp)


            \end{minipage}
        };
        %------------ Non idealità Slew Rate Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Non idealità: Slew Rate};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Non idealità: Slew Rate}{OpAmp - Non idealità: Slew Rate}}{OpAmp - Non idealità: Slew Rate}}{OpAmp - Non idealità: Slew Rate}}{OpAmp - Non idealità: Slew Rate}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{Errore Statico di Guadagno:}

                \vspace{0.15cm}
                Differenza tra uscita ideale e reale dovuta a $G_{loop}$ finito

                \vspace{0.15cm}
                \textbf{Origine:} L'OpAmp reale ha $\varepsilon \neq 0$ (segnale d'errore non nullo)

                \vspace{0.15cm}
                \textbf{Formula errore:}
                ...
                \vspace{0.05cm}
                $$\boxed{\text{Errore} = V_{IN} \cdot \frac{G_{ID}}{1 - G_{loop}}}$$

                \vspace{0.15cm}
                \textbf{Come trovare l'ERRORE MASSIMO:}

                \vspace{0.1cm}
                Per massimizzare l'errore, osservare la formula:

                \vspace{0.05cm}
                $$\text{Errore}_{\text{MAX}} = V_{IN}\big|_{\text{MAX}} \cdot \frac{G_{ID}\big|_{\text{MAX}}}{1 - G_{loop}\big|_{\text{MIN}}}$$

                \vspace{0.1cm}
                \textbf{Strategia:}

                \vspace{0.05cm}
                1. \textbf{Massimizzare} $V_{IN}$ (prendere il valore massimo)

                \vspace{0.05cm}
                2. \textbf{Massimizzare} $G_{ID}$ (numeratore)

                \vspace{0.05cm}
                3. \textbf{Minimizzare} $G_{loop}$ (denominatore)

                \vspace{0.1cm}
                dove $G_{loop}(0)$ è il guadagno d'anello in \textbf{continua}

                \vspace{0.15cm}
                \footnotesize
                    \textbf{$\bigstar$ TRADE-OFF tra parametri:}

                    \vspace{0.05cm}
                    Se un parametro \textbf{massimizza $G_{ID}$ ma NON minimizza $G_{loop}$}:

                    \vspace{0.05cm}
                    $\Rightarrow$ Calcola l'errore per \textbf{entrambi i casi} e prendi il \textbf{MASSIMO}

                    \vspace{0.05cm}
                    Esempio: se $R_1$ alta $\to$ $G_{ID}$ alto ma $G_{loop}$ alto (errore basso)

                    \hspace{1.3cm} e $R_1$ bassa $\to$ $G_{ID}$ basso ma $G_{loop}$ basso (errore ?)
        ...
        %------------ Non idealità Errore Guadagno Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Non idealità: Errore Statico di Guadagno};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Non idealità: Errore Statico di Guadagno}{OpAmp - Non idealità: Errore Statico di Guadagno}}{OpAmp - Non idealità: Errore Statico di Guadagno}}{OpAmp - Non idealità: Errore Statico di Guadagno}}{OpAmp - Non idealità: Errore Statico di Guadagno}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Risposta al Gradino - Sistema 1$^\circ$ Ordine};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Risposta al Gradino - Sistema 1 Ordine}{Risposta al Gradino - Sistema 1 Ordine}}{Risposta al Gradino - Sistema 1 Ordine}}{Risposta al Gradino - Sistema 1 Ordine}}{Risposta al Gradino - Sistema 1 Ordine}}
    \end{tikzpicture}

    \vspace{0.3cm}

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %------------ OpAmp - Effetti Dinamici e Risposta in Frequenza ---------------
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{OpAmp - Analisi Dinamica con Condensatore}

                \vspace{0.15cm}
                Quando un circuito OpAmp include condensatori, il comportamento dinamico introduce poli/zeri.

                \vspace{0.15cm}
                \textbf{Procedimento generale:}

                \vspace{0.1cm}
                \begin{enumerate}[leftmargin=*,itemsep=0pt]
                    \item Calcolare $Z_{eq}$ (impedenza equivalente nel dominio $s$)
                    \item Calcolare $G_{ID}(s)$ (guadagno ideale in frequenza)
                    \item Identificare poli e zeri dalla forma di $G_{ID}(s)$
                    \item Determinare il tipo di filtro (passa-alto, passa-basso, passa-banda)
                \end{enumerate}

                \vspace{0.15cm}
                \textbf{Esempio - Filtro Passa-Alto:}
                ...
                \vspace{0.1cm}
                • \textbf{Zero nell'origine}: $s$ al numeratore

                • \textbf{Polo}: $\omega_p = \dfrac{1}{C_1R_1}$ $\Rightarrow$ $f_p = \dfrac{1}{2\pi C_1R_1}$

                \vspace{0.15cm}
                \textbf{Interpretazione:}

                \vspace{0.05cm}
                • Zero nell'origine $\Rightarrow$ \textbf{Filtro passa-alto}

                • Il polo $f_p$ determina la frequenza di taglio

                • Per far passare tutto il segnale: porre $f_p$ \textbf{sotto} la freq. minima del segnale
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Analisi Dinamica};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Analisi Dinamica}{OpAmp - Analisi Dinamica}}{OpAmp - Analisi Dinamica}}{OpAmp - Analisi Dinamica}}{OpAmp - Analisi Dinamica}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{OpAmp Non Compensato - 2 Poli}

                \vspace{0.15cm}
                Un OpAmp \textbf{non compensato} ha una funzione di trasferimento con \textbf{due poli}:

                \vspace{0.15cm}
                \colorbox{cyan!20}{\parbox{0.95\linewidth}{
                    \textbf{$\bigstar$ Funzione di trasferimento:}

                    \vspace{0.1cm}
                    $$\boxed{A(s) = \frac{A_0}{(1 + s/\omega_1)(1 + s/\omega_2)}}$$
                ...
                \vspace{0.15cm}
                \colorbox{red!25}{\parbox{0.95\linewidth}{
                    \textbf{$\triangle$ PROBLEMA nel BUFFER:}

                    \vspace{0.1cm}
                    Un OpAmp a \textbf{2 poli} usato in configurazione buffer (guadagno = 1) \textbf{NON garantisce stabilità}!

                    \vspace{0.1cm}
                    • Margine di fase può essere \textbf{insufficiente}

                    • Rischio di \textbf{oscillazioni}
                ...
                \colorbox{green!25}{\parbox{0.95\linewidth}{
                    \textbf{$\bigstar$ BUFFER con OpAmp a SINGOLO POLO:}

                    \vspace{0.1cm}
                    $$A(s) = \frac{A_0}{1 + s/\omega_1}$$

                    \vspace{0.1cm}
                    $\Rightarrow$ \textbf{SEMPRE STABILE} in configurazione buffer!

                    \vspace{0.05cm}
                    • Margine di fase = 90° (pendenza -20 dB/dec)
                ...
                \vspace{0.15cm}
                \textbf{Trade-off con retroazione:}
                ...
                • Ma si \textbf{riduce} il margine di stabilità

                • Massima stabilità quando $f_T = f_1$ (frequenza primo polo)

                \vspace{0.1cm}
                \footnotesize
                \textit{Grafico Bode: mostrare intersezione loop gain con 0 dB e margine di fase}

            \end{minipage}
        };
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp Non Compensato - Stabilità};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp Non Compensato - Stabilità}{OpAmp Non Compensato - Stabilità}}{OpAmp Non Compensato - Stabilità}}{OpAmp Non Compensato - Stabilità}}{OpAmp Non Compensato - Stabilità}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{Integratore con OpAmp - Ideale}

                \vspace{0.15cm}
                \textbf{Schema circuitale:}
                ...
                \vspace{0.15cm}
                \colorbox{cyan!20}{\parbox{0.95\linewidth}{
                    \textbf{$\bigstar$ EQUAZIONE DIFFERENZIALE:}

                    \vspace{0.1cm}
                    $$\boxed{\frac{dV_{out}}{dt} = -\frac{1}{RC} \cdot V_{in}(t)}$$
                ...
                \vspace{0.15cm}
                \textbf{Funzione di trasferimento (dominio $s$):}

                \vspace{0.05cm}
                $$G_{id}(s) = \frac{V_{out}(s)}{V_{in}(s)} = -\frac{1}{sRC}$$

                \vspace{0.1cm}
                • Filtro \textbf{passa-basso} del primo ordine

                • Guadagno aumenta a basse frequenze ($\propto 1/f$)

                • Sfasamento: -90° (+ inversione da segno -)

                \vspace{0.15cm}
                \textbf{Esempio - Ingresso a gradino:}

                \vspace{0.05cm}
                • $V_{in} = V_0 \cdot u(t)$ (costante)

                • $V_{out}(t) = -\dfrac{V_0}{RC} \cdot t$ (\textbf{rampa lineare}!)

                \vspace{0.15cm}
                \textbf{Esempio - Ingresso sinusoidale:}

                \vspace{0.05cm}
                • $V_{in} = A \sin(\omega t)$

                • $V_{out} = \dfrac{A}{\omega RC} \cos(\omega t)$ (sfasato 90°, invertito)

            \end{minipage}
        };
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Integratore OpAmp - Ideale};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Integratore OpAmp - Ideale}{Integratore OpAmp - Ideale}}{Integratore OpAmp - Ideale}}{Integratore OpAmp - Ideale}}{Integratore OpAmp - Ideale}}
    \end{tikzpicture}

    \vspace{0.3cm}

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %------------ Integratore OpAmp - Reale (Problema I_B) ---------------
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{Integratore REALE - Problema $I_B$}

                \vspace{0.15cm}
                \colorbox{red!25}{\parbox{0.95\linewidth}{
                    \textbf{$\triangle$ PROBLEMA con OpAmp REALE:}
                    ...
                    \vspace{0.1cm}
                    $\Rightarrow$ $V_{out}$ aumenta linearmente fino alla \textbf{saturazione} ($V_{sat}$)

                    \vspace{0.1cm}
                    $\Rightarrow$ L'integratore si \textbf{satura} anche senza ingresso!

                    \vspace{0.05cm}
                    In pratica: $V_C(t) = \dfrac{I_B}{C} \cdot t + V_0$ $\to V_{alim}$
                }}

                \vspace{0.15cm}
                \colorbox{green!25}{\parbox{0.95\linewidth}{
                    \textbf{$\bigstar$ SOLUZIONE: Resistenza $R_2$ in parallelo a $C$}

                    \vspace{0.1cm}
                    Aggiungere $R_2$ in parallelo al condensatore:

                    \vspace{0.05cm}
                    • Permette \textbf{scarica DC} del condensatore
                    ...
                    \vspace{0.05cm}
                    • $R_2$ abbastanza \textbf{grande}: non degrada troppo l'integrazione

                    • $R_2$ abbastanza \textbf{piccola}: previene saturazione

                    \vspace{0.05cm}
                    Tipicamente: $R_2 \approx 10 \cdot R$ oppure $R_2 > \dfrac{V_{sat}}{I_B}$
                }}

                \vspace{0.15cm}
                \textbf{Funzione di trasferimento modificata:}

                \vspace{0.05cm}
                $$G(s) = -\frac{R_2/R}{1 + sR_2C}$$

                \vspace{0.1cm}
                • A \textbf{bassa frequenza}: integratore perfetto

                • A \textbf{DC} ($s=0$): guadagno finito $-R_2/R$ (no saturazione!)

                • Polo a $f_p = \dfrac{1}{2\pi R_2 C}$

            \end{minipage}
        };
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Integratore Reale - Problema $I_B$};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Integratore Reale - Problema}{Integratore Reale - Problema}}{Integratore Reale - Problema}}{Integratore Reale - Problema}}{Integratore Reale - Problema }}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ DAC R2R Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}DAC R-2R (Resistor Ladder)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{DAC R-2R (Resistor Ladder)}{DAC R-2R (Resistor Ladder)}}{DAC R-2R (Resistor Ladder)}}{DAC R-2R (Resistor Ladder)}}{DAC R-2R (Resistor Ladder)}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        %------------ DAC FSR LSB Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}DAC - FSR e LSB};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{DAC - FSR e LSB}{DAC - FSR e LSB}}{DAC - FSR e LSB}}{DAC - FSR e LSB}}{DAC - FSR e LSB}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ DAC DNL Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}DAC - DNL (1/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{DAC - DNL (1/2)}{DAC - DNL (1/2)}}{DAC - DNL (1/2)}}{DAC - DNL (1/2)}}{DAC - DNL (1/2)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ DAC DNL Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}DAC - DNL (2/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{DAC - DNL (2/2)}{DAC - DNL (2/2)}}{DAC - DNL (2/2)}}{DAC - DNL (2/2)}}{DAC - DNL (2/2)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ DAC Dinamica Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}DAC - Dinamica Transizioni (OpAmp reale)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{DAC - Dinamica Transizioni (OpAmp reale)}{DAC - Dinamica Transizioni (OpAmp reale)}}{DAC - Dinamica Transizioni (OpAmp reale)}}{DAC - Dinamica Transizioni (OpAmp reale)}}{DAC - Dinamica Transizioni (OpAmp reale)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}DAC a Correnti Pesate};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{DAC a Correnti Pesate}{DAC a Correnti Pesate}}{DAC a Correnti Pesate}}{DAC a Correnti Pesate}}{DAC a Correnti Pesate}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}DAC Correnti Pesate - Deviatori};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{DAC Correnti Pesate - Deviatori}{DAC Correnti Pesate - Deviatori}}{DAC Correnti Pesate - Deviatori}}{DAC Correnti Pesate - Deviatori}}{DAC Correnti Pesate - Deviatori}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}DAC Correnti Pesate - DNL};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{DAC Correnti Pesate - DNL}{DAC Correnti Pesate - DNL}}{DAC Correnti Pesate - DNL}}{DAC Correnti Pesate - DNL}}{DAC Correnti Pesate - DNL}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}DAC Correnti Pesate - Dinamica};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{DAC Correnti Pesate - Dinamica}{DAC Correnti Pesate - Dinamica}}{DAC Correnti Pesate - Dinamica}}{DAC Correnti Pesate - Dinamica}}{DAC Correnti Pesate - Dinamica}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Comparatore a Singola Soglia};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Comparatore a Singola Soglia}{Comparatore a Singola Soglia}}{Comparatore a Singola Soglia}}{Comparatore a Singola Soglia}}{Comparatore a Singola Soglia}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Comparatore a Doppia Soglia (Isteresi)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Comparatore a Doppia Soglia (Isteresi)}{Comparatore a Doppia Soglia (Isteresi)}}{Comparatore a Doppia Soglia (Isteresi)}}{Comparatore a Doppia Soglia (Isteresi)}}{Comparatore a Doppia Soglia (Isteresi)}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Trigger di Schmitt - Tabella Comparativa};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Trigger di Schmitt - Tabella Comparativa}{Trigger di Schmitt - Tabella Comparativa}}{Trigger di Schmitt - Tabella Comparativa}}{Trigger di Schmitt - Tabella Comparativa}}{Trigger di Schmitt - Tabella Comparativa}}
    \end{tikzpicture}

    \vspace{0.3cm}

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %------------ Comparatore - Problema Rumore vs Isteresi ---------------
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{Comparatore Semplice vs con Isteresi}

                \vspace{0.15cm}
                \colorbox{red!25}{\parbox{0.95\linewidth}{
                    \textbf{$\triangle$ PROBLEMA - Comparatore a soglia singola:}

                    \vspace{0.1cm}
                    Quando $V_{in} \approx V_{soglia}$ e c'è \textbf{rumore}:

                    \vspace{0.05cm}
                    • L'uscita commuta \textbf{multiple volte} (chatter)
                    ...
                    \vspace{0.1cm}
                    \textit{Grafico: $V_{in}$ con rumore che oscilla attorno alla soglia}
                ...
                \vspace{0.15cm}
                \colorbox{green!25}{\parbox{0.95\linewidth}{
                    \textbf{$\bigstar$ SOLUZIONE - Isteresi (Trigger di Schmitt):}

                    \vspace{0.1cm}
                    Due soglie diverse: $V_{LH}$ (basso$\to$alto) e $V_{HL}$ (alto$\to$basso)
                    ...
                    \vspace{0.05cm}
                    • Il rumore deve superare \textbf{ENTRAMBE} le soglie per causare commutazione

                    \vspace{0.1cm}
                    $\Rightarrow$ Il sistema è \textbf{stabile} anche in presenza di rumore fino a $\Delta V < |V_{HL} - V_{LH}|$
                }}

                \vspace{0.15cm}
                \textbf{Dimensionamento banda morta:}

                \vspace{0.05cm}
                • Banda morta \textbf{troppo stretta}: rumore può ancora causare problemi

                \vspace{0.05cm}
                • Banda morta \textbf{troppo larga}: perdita di precisione nella soglia

                \vspace{0.05cm}
                \textit{Regola pratica:} Banda morta $\approx 2-3 \times$ ampiezza rumore attesa

            \end{minipage}
        };
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Comparatore - Rumore vs Isteresi};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Comparatore - Rumore vs Isteresi}{Comparatore - Rumore vs Isteresi}}{Comparatore - Rumore vs Isteresi}}{Comparatore - Rumore vs Isteresi}}{Comparatore - Rumore vs Isteresi}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Trigger di Schmitt - Funzionamento};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Trigger di Schmitt - Funzionamento}{Trigger di Schmitt - Funzionamento}}{Trigger di Schmitt - Funzionamento}}{Trigger di Schmitt - Funzionamento}}{Trigger di Schmitt - Funzionamento}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Trigger di Schmitt - Caratteristica};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Trigger di Schmitt - Caratteristica}{Trigger di Schmitt - Caratteristica}}{Trigger di Schmitt - Caratteristica}}{Trigger di Schmitt - Caratteristica}}{Trigger di Schmitt - Caratteristica}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Trigger di Schmitt - Calcolo Soglie};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Trigger di Schmitt - Calcolo Soglie}{Trigger di Schmitt - Calcolo Soglie}}{Trigger di Schmitt - Calcolo Soglie}}{Trigger di Schmitt - Calcolo Soglie}}{Trigger di Schmitt - Calcolo Soglie}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Trigger di Schmitt - Metodo Calcolo Soglie};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Trigger di Schmitt - Metodo Calcolo Soglie}{Trigger di Schmitt - Metodo Calcolo Soglie}}{Trigger di Schmitt - Metodo Calcolo Soglie}}{Trigger di Schmitt - Metodo Calcolo Soglie}}{Trigger di Schmitt - Metodo Calcolo Soglie}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Trigger di Schmitt - Grafici Isteresi};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Trigger di Schmitt - Grafici Isteresi}{Trigger di Schmitt - Grafici Isteresi}}{Trigger di Schmitt - Grafici Isteresi}}{Trigger di Schmitt - Grafici Isteresi}}{Trigger di Schmitt - Grafici Isteresi}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Introduzione};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Introduzione}{ADC - Introduzione}}{ADC - Introduzione}}{ADC - Introduzione}}{ADC - Introduzione}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \vspace{0.15cm}
                \begin{center}
                    \begin{tikzpicture}[scale=0.6, every node/.style={scale=0.8}, color=black]
                        % Blocks
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Catena di Acquisizione};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Catena di Acquisizione}{Catena di Acquisizione}}{Catena di Acquisizione}}{Catena di Acquisizione}}{Catena di Acquisizione}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Sample \& Hold};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Sample e Hold}{Sample e Hold}}{Sample e Hold}}{Sample e Hold}}{Sample e Hold}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Sample \& Hold con Buffer};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Sample e Hold con Buffer}{Sample e Hold con Buffer}}{Sample e Hold con Buffer}}{Sample e Hold con Buffer}}{Sample e Hold con Buffer}}
    \end{tikzpicture}

    \vspace{0.3cm}

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %------------ Buffer - Analisi Dinamica e Dimensionamento ---------------
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{Buffer - Dimensionamento per Risposta in Frequenza}

                \vspace{0.15cm}
                Quando il buffer include componenti reattivi (condensatori), il sistema ha risposta in frequenza.

                \vspace{0.15cm}
                \textbf{Esempio: Amplificatore + Buffer con accoppiamento AC}
                ...
                \vspace{0.1cm}
                Impedenza di ingresso: $Z_{eq} = R_1 + \dfrac{1}{sC_1}$

                \vspace{0.05cm}
                Guadagno ideale dell'amplificatore:

                \vspace{0.05cm}
                $$G_{ID}(s) = -\frac{R_2}{Z_{eq}} = -\frac{sC_1R_2}{1 + sC_1R_1}$$

                \vspace{0.1cm}
                • \textbf{Zero nell'origine} $\Rightarrow$ Filtro passa-alto

                • \textbf{Polo}: $f_p = \dfrac{1}{2\pi C_1 R_1}$

                \vspace{0.15cm}
                \textbf{Criterio di dimensionamento:}

                \vspace{0.1cm}
                Per garantire che \textbf{tutta la banda del segnale} passi inalterata:

                \vspace{0.05cm}
                $$\boxed{f_p \le f_{segnale,\,min}}$$

                \vspace{0.1cm}
                Dove $f_{segnale,\,min}$ è la frequenza \textbf{minima} del segnale d'ingresso.

                \vspace{0.05cm}
                Esempio: Se il segnale ha componenti $\ge 10$ Hz, porre $f_p = 10$ Hz:
                ...
                \footnotesize
                    ...
                    \vspace{0.05cm}
                    • Il buffer ($G=1$) \textbf{non modifica} il guadagno, solo isola l'ADC

                    \vspace{0.05cm}
                    • La dinamica è determinata dall'\textbf{amplificatore}, non dal buffer
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Buffer - Dimensionamento Dinamico};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Buffer - Dimensionamento Dinamico}{Buffer - Dimensionamento Dinamico}}{Buffer - Dimensionamento Dinamico}}{Buffer - Dimensionamento Dinamico}}{Buffer - Dimensionamento Dinamico}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Adattamento e Dinamica};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Adattamento e Dinamica}{ADC - Adattamento e Dinamica}}{ADC - Adattamento e Dinamica}}{ADC - Adattamento e Dinamica}}{ADC - Adattamento e Dinamica}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \vspace{0.15cm}
                    ...
                    \vspace{0.1cm}
                    \begin{center}
                        \begin{circuitikz}[scale=0.6, color=black]
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Buffer e Errore Statico};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Buffer e Errore Statico}{ADC - Buffer e Errore Statico}}{ADC - Buffer e Errore Statico}}{ADC - Buffer e Errore Statico}}{ADC - Buffer e Errore Statico}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Richieste Tipiche d'Esame};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Richieste Tipiche d'Esame}{ADC - Richieste Tipiche d'Esame}}{ADC - Richieste Tipiche d'Esame}}{ADC - Richieste Tipiche d'Esame}}{ADC - Richieste Tipiche d'Esame}}
    \end{tikzpicture}

    \vspace{0.3cm}

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %------------ ADC - Altre Richieste Tipiche d'Esame ---------------
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{Altre Richieste Tipiche d'Esame - ADC}

                \vspace{0.15cm}

                    \textbf{4. CALCOLO RISOLUZIONE}

                    \vspace{0.1cm}
                    Determinare LSB dell'ADC e LSB all'ingresso:

                    \vspace{0.05cm}
                    $$\boxed{LSB_{ADC} = \frac{FSR}{2^N} = \frac{V_{DD} - V_{SS}}{2^N}}$$
                ...
                \vspace{0.15cm}
                    ...
                    \textbf{5. DIMENSIONAMENTO $V_{REF}$ dell'ADC}
                ...
                \vspace{0.15cm}
                    ...
                    \textbf{6. TIMING del S\&H}

                    \vspace{0.1cm}
                    \textbf{a) Calcolo $T_{sample,min}$ per caricare $C_H$:}

                    \vspace{0.05cm}
                    Usando formula carica condensatore attraverso $R_{DS,on}$:

                    $$T_{sample} \ge n\tau = n \cdot R_{DS,on} \cdot C_H$$

                    con $n = 5-7$ costanti di tempo per precisione desiderata.

                    \vspace{0.1cm}
                    \textbf{b) Calcolo $T_{hold,min}$ per conversione ADC:}

                    \vspace{0.05cm}
                    $$T_{hold} \ge T_{conv,ADC}$$

                    dove $T_{conv}$ dipende dal tipo di ADC (SAR, Doppia Rampa, etc.).

                    \vspace{0.1cm}
                    \textbf{c) Frequenza massima di campionamento:}
                ...
                \vspace{0.15cm}
                    ...
                    \textbf{7. ERRORI COMBINATI (Worst-Case)}

                    \vspace{0.1cm}
                    Errore da $I_B$ + charge injection + offset:

                    \vspace{0.05cm}
                    $$\varepsilon_{tot} = |\varepsilon_{I_B}| + |\varepsilon_{inj}| + |\varepsilon_{OS}| + \ldots$$
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Altre Richieste Esame};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Altre Richieste Esame}{ADC - Altre Richieste Esame}}{ADC - Altre Richieste Esame}}{ADC - Altre Richieste Esame}}{ADC - Altre Richieste Esame}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Errore da $I_B$ nel S\&H};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Errore da  nel SeH}{ADC - Errore da  nel SeH}}{ADC - Errore da  nel SeH}}{ADC - Errore da  nel SeH}}{ADC - Errore da  nel SeH}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}S\&H - Comando nMOS};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{SeH - Comando nMOS}{SeH - Comando nMOS}}{SeH - Comando nMOS}}{SeH - Comando nMOS}}{SeH - Comando nMOS}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \vspace{0.15cm}
                    ...
                    • Il charge injection \textbf{sottrae} ca
                    rica a $C_H$
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}S\&H - Charge Injection};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{SeH - Charge Injection}{SeH - Charge Injection}}{SeH - Charge Injection}}{SeH - Charge Injection}}{SeH - Charge Injection}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - LSB all'Ingresso e Numero di Bit};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - LSB all'Ingresso e Numero di Bit}{ADC - LSB all'Ingresso e Numero di Bit}}{ADC - LSB all'Ingresso e Numero di Bit}}{ADC - LSB all'Ingresso e Numero di Bit}}{ADC - LSB all'Ingresso e Numero di Bit}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Tempi di Sample e Hold};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Tempi di Sample e Hold}{ADC - Tempi di Sample e Hold}}{ADC - Tempi di Sample e Hold}}{ADC - Tempi di Sample e Hold}}{ADC - Tempi di Sample e Hold}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Risposta con Guadagno $A(s)$};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Risposta con Guadagno}{ADC - Risposta con Guadagno}}{ADC - Risposta con Guadagno}}{ADC - Risposta con Guadagno}}{ADC - Risposta con Guadagno}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Dimens. $V_B$ e Errore Fondo Scala};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Dimens.  e Errore Fondo Scala}{ADC - Dimens.  e Errore Fondo Scala}}{ADC - Dimens.  e Errore Fondo Scala}}{ADC - Dimens.  e Errore Fondo Scala}}{ADC - Dimens.  e Errore Fondo Scala}}
    \end{tikzpicture}

    \vspace{0.3cm}

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %------------ SEZIONE: TIPOLOGIE DI ADC ---------------
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{ADC SAR (Successive Approximation Register)}

                \vspace{0.15cm}
                Convertitore a \textbf{approssimazioni successive}: il più usato per velocità e precisione.
                ...
                \vspace{0.15cm}
                    ...
                    \textbf{Formula Tempo di Conversione:}

                    \vspace{0.1cm}
                    $$\boxed{T_{conv} = (N+1) \cdot T_{ck}}$$

                    oppure (dipende dall'implementazione):

                    $$\boxed{T_{conv} = N \cdot T_{ck}}$$
                    ...
                    • $T_{ck} = \dfrac{1}{f_{ck}}$ = periodo di clock


                \vspace{0.15cm}

                    \textbf{$\bigstar$ Richiesta tipica d'esame:}

                    \vspace{0.1cm}
                    \textit{``Determinare la minima frequenza di clock necessaria.''}

                    \vspace{0.1cm}
                    \textbf{Soluzione:} Imponi che il tempo di conversione non superi il tempo di hold:

                    $$T_{conv} \le T_{hold}$$

                    \vspace{0.05cm}
                    $(N+1) \cdot T_{ck} \le T_{hold}$

                    \vspace{0.05cm}
                    $$\boxed{f_{ck} \ge \frac{N+1}{T_{hold}}}$$
                ...
                \footnotesize
                    ...
                    \vspace{0.05cm}
                    $f_{ck,min} = \dfrac{10+1}{50\,\mu s} = \dfrac{11}{50 \times 10^{-6}} = 220$ kHz


                \vspace{0.15cm}
                \footnotesize
                    \textbf{$\bigstar$ Velocità:}

                    \vspace{0.05cm}
                    Il tempo di conversione cresce \textbf{linearmente} con $N$ (molto più veloce di singola rampa).
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - SAR (Successive Approximation)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - SAR (Successive Approximation)}{ADC - SAR (Successive Approximation)}}{ADC - SAR (Successive Approximation)}}{ADC - SAR (Successive Approximation)}}{ADC - SAR}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{ADC a Doppia Rampa (Dual Slope)}

                \vspace{0.15cm}
                Convertitore usato per \textbf{precisione} e \textbf{reiezione ai disturbi}, non per velocità.

                \vspace{0.15cm}
                \textbf{Principio:}

                \vspace{0.1cm}
                • \textbf{Fase 1 (Integrazione):} Il segnale $V_{in}$ viene integrato per un tempo fisso $T_{int}$

                • \textbf{Fase 2 (De-integrazione):} Una tensione di riferimento $-V_{ref}$ viene integrata fino a tornare a zero
                ...
                \vspace{0.15cm}
                    ...
                    \vspace{0.05cm}
                    Nel \textbf{caso peggiore}:

                    $$T_{deint,max} = 2^N \cdot T_{ck}$$

                    \vspace{0.05cm}
                    $$\boxed{T_{conv,max} \approx 2 \cdot T_{int}}$$


                \vspace{0.15cm}

                    \textbf{$\bigstar$ REIEZIONE DISTURBI:}

                    \vspace{0.1cm}
                    Se $T_{int}$ è un \textbf{multiplo intero} del periodo di un disturbo periodico (es. rete elettrica 50 Hz), l'ADC \textbf{cancella} quel disturbo!

                    \vspace{0.05cm}
                    Esempio: $T_{int} = 20$ ms $= \dfrac{1}{50\text{ Hz}}$ $\Rightarrow$ reiezione perfetta di disturbi a 50 Hz


                \vspace{0.15cm}
                \footnotesize
                    \textbf{Calcolo bit del contatore:}
                    ...
                    3. $n \ge \log_2(N_{max})$ (arrotonda all'intero superiore)


            \end{minipage}
        };
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Doppia Rampa (Dual Slope)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Doppia Rampa (Dual Slope)}{ADC - Doppia Rampa (Dual Slope)}}{ADC - Doppia Rampa (Dual Slope)}}{ADC - Doppia Rampa (Dual Slope)}}{ADC - Doppia Rampa}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{ADC a Singola Rampa (A Gradinata)}

                \vspace{0.15cm}
                Convertitore \textbf{molto lento}: confronta $V_{in}$ con una rampa crescente generata da un contatore + DAC.
                ...
                \vspace{0.1cm}
                $\Rightarrow$ Il valore del contatore è il risultato della conversione.

                \vspace{0.15cm}

                    \textbf{Formula Tempo di Conversione (CASO PEGGIORE):}

                    \vspace{0.1cm}
                    Nel caso peggiore, il contatore deve contare fino a $2^N$:

                    $$\boxed{T_{conv,max} = 2^N \cdot T_{ck}}$$
                ...
                \vspace{0.15cm}
                    ...
                    \vspace{0.1cm}
                    \textit{``Ripetere il calcolo della frequenza di clock nel caso di ADC a singola rampa.''}

                    \vspace{0.1cm}
                    \textbf{Soluzione:} Imponi $T_{conv,max} \le T_{hold}$:

                    $$2^N \cdot T_{ck} \le T_{hold}$$

                    \vspace{0.05cm}
                    $$\boxed{f_{ck} \ge \frac{2^N}{T_{hold}}}$$
                ...
                \footnotesize
                    ...
                    \vspace{0.05cm}
                    $f_{ck,min} = \dfrac{2^{10}}{50\,\mu s} = \dfrac{1024}{50 \times 10^{-6}} \approx 20.5$ MHz


                \vspace{0.15cm}
                \footnotesize
                    \textbf{$\triangle$ PROBLEMA:}

                    \vspace{0.05cm}
                    Il tempo di conversione cresce \textbf{esponenzialmente} con $N$ $\Rightarrow$ richiede frequenze di clock \textbf{altissime} (GHz per $N>10$).

                    \vspace{0.05cm}
                    $\Rightarrow$ Spesso \textbf{impraticabile} per tempi di hold brevi!


            \end{minipage}
        };
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Singola Rampa (A Gradinata)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Singola Rampa (A Gradinata)}{ADC - Singola Rampa (A Gradinata)}}{ADC - Singola Rampa (A Gradinata)}}{ADC - Singola Rampa (A Gradinata)}}{ADC - Singola Rampa}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{ADC a Inseguimento (Tracking)}

                \vspace{0.15cm}
                Convertitore che \textbf{insegue} il segnale: non riparte da zero ad ogni conversione, ma sale o scende di 1 LSB per volta.
                ...
                \vspace{0.1cm}
                $\Rightarrow$ Il contatore ``segue'' le variazioni del segnale.

                \vspace{0.15cm}

                    \textbf{Condizione critica: SLOPE OVERLOAD}

                    \vspace{0.1cm}
                    La pendenza del segnale d'ingresso \textbf{non deve superare} la velocità massima di inseguimento dell'ADC:

                    $$\boxed{\frac{dV_{in}}{dt} \le \frac{dV_{max}}{dt} = \frac{LSB}{T_{ck}}}$$

                    \vspace{0.05cm}
                    oppure:

                    $$\boxed{\frac{dV_{in}}{dt} \le LSB \cdot f_{ck}}$$

                    \vspace{0.1cm}
                    dove:

                    • $LSB = \dfrac{V_{DD} - V_{SS}}{2^N}$ = risoluzione ADC
                ...
                \vspace{0.15cm}
                    ...
                    \vspace{0.1cm}
                    \textit{``Determinare la frequenza/ampiezza massima del segnale d'ingresso affinché l'ADC possa convertirlo correttamente.''}

                    \vspace{0.1cm}
                    \textbf{Soluzione per sinusoide} $V_{in} = A \sin(2\pi f t)$:

                    \vspace{0.05cm}
                    Derivata massima: $\dfrac{dV_{in}}{dt}\bigg|_{max} = 2\pi f A$

                    \vspace{0.05cm}
                    Imponi: $2\pi f A \le LSB \cdot f_{ck}$

                    \vspace{0.05cm}
                    $$\boxed{f \le \frac{LSB \cdot f_{ck}}{2\pi A}}$$
                ...
                \footnotesize
                    ...
                    \vspace{0.05cm}
                    $LSB = 10$ mV, $f_{ck} = 1$ MHz, $A = 1$ V

                    \vspace{0.05cm}
                    $f_{max} = \dfrac{10 \times 10^{-3} \times 10^6}{2\pi \times 1} \approx 1.59$ kHz


                \vspace{0.15cm}
                \footnotesize
                    \textbf{$\bigstar$ Vantaggio:}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Inseguimento (Tracking)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Inseguimento (Tracking)}{ADC - Inseguimento (Tracking)}}{ADC - Inseguimento (Tracking)}}{ADC - Inseguimento (Tracking)}}{ADC - Inseguimento}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Terminologia};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Terminologia}{ADC - Terminologia}}{ADC - Terminologia}}{ADC - Terminologia}}{ADC - Terminologia}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}GUIDA - Riconoscere Configurazioni (1/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{GUIDA - Riconoscere Configurazioni (1/2)}{GUIDA - Riconoscere Configurazioni (1/2)}}{GUIDA - Riconoscere Configurazioni (1/2)}}{GUIDA - Riconoscere Configurazioni (1/2)}}{GUIDA - Riconoscere Configurazioni (1/2)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}GUIDA - Riconoscere Configurazioni (2/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{GUIDA - Riconoscere Configurazioni (2/2)}{GUIDA - Riconoscere Configurazioni (2/2)}}{GUIDA - Riconoscere Configurazioni (2/2)}}{GUIDA - Riconoscere Configurazioni (2/2)}}{GUIDA - Riconoscere Configurazioni (2/2)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \colorbox{cyan!20}{\parbox{0.95\linewidth}{
                    ...
                    \vspace{0.05cm}
                    • \textbf{Multi} = più di uno stato (in questo caso: \textbf{due} stati)

                    • \textbf{Astabile} = nessuno dei due stati è \textbf{stabile}

                    \vspace{0.05cm}
                    $\Rightarrow$ Il circuito oscilla continuamente tra i due stati senza input esterno!
                }}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Multivibratore Astabile (1/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Multivibratore Astabile (1/2)}{Multivibratore Astabile (1/2)}}{Multivibratore Astabile (1/2)}}{Multivibratore Astabile (1/2)}}{Multivibratore Astabile (1/2)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \vspace{0.15cm}
                \begin{center}
                \begin{tikzpicture}[scale=0.75, color=black]
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Multivibratore - Forme d'Onda};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Multivibratore - Forme d'Onda}{Multivibratore - Forme d'Onda}}{Multivibratore - Forme d'Onda}}{Multivibratore - Forme d'Onda}}{Multivibratore - Forme d'Onda}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Multivibratore Astabile (2/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Multivibratore Astabile (2/2)}{Multivibratore Astabile (2/2)}}{Multivibratore Astabile (2/2)}}{Multivibratore Astabile (2/2)}}{Multivibratore Astabile (2/2)}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Multivibratore - Commutazione};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Multivibratore - Commutazione}{Multivibratore - Commutazione}}{Multivibratore - Commutazione}}{Multivibratore - Commutazione}}{Multivibratore - Commutazione}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Multivibratore Astabile - Esame (1/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Multivibratore Astabile - Esame (1/2)}{Multivibratore Astabile - Esame (1/2)}}{Multivibratore Astabile - Esame (1/2)}}{Multivibratore Astabile - Esame (1/2)}}{Multivibratore Astabile - Esame (1/2)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Multivibratore Astabile - Esame (2/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Multivibratore Astabile - Esame (2/2)}{Multivibratore Astabile - Esame (2/2)}}{Multivibratore Astabile - Esame (2/2)}}{Multivibratore Astabile - Esame (2/2)}}{Multivibratore Astabile - Esame (2/2)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{Generatore di Forme d'Onda}

                \vspace{0.15cm}
                \textbf{Combinazione: Multivibratore Astabile + Integratore}
                ...
                \vspace{0.1cm}
                \begin{center}
                    \begin{tikzpicture}[scale=0.7, every node/.style={scale=0.8}, color=black]
                        % Blocks
                        \draw[thick] (0,0) rectangle (2,1) node[midway] {\tiny Multivib.};
                        \draw[thick] (2.5,0) rectangle (4.5,1) node[midway] {\tiny Integr.};
                        % Arrows
                        \draw[->, thick] (2,0.5) -- (2.5,0.5);
                        \draw[->, thick] (4.5,0.5) -- (5.2,0.5) node[right] {\tiny $\triangle$};
                        % Labels
                        \node[below] at (1,0) {\tiny onda quadra};
                        \node[below] at (3.5,0) {\tiny onda triangolare};
                    \end{tikzpicture}
                \end{center}

                \vspace{0.1cm}
                • Multivibratore astabile genera \textbf{onda quadra}

                • Uscita del multivibratore $\to$ ingresso dell'integratore

                • Integratore trasforma onda quadra in \textbf{onda triangolare}
                ...
                \colorbox{cyan!20}{\parbox{0.95\linewidth}{
                    ...
                    • Integra l'onda quadra con $G_{ID}(s) = -\dfrac{1}{sRC}$

                    • Quando $V_{in} = +V_{sat}$: rampa \textbf{discendente}

                    • Quando $V_{in} = -V_{sat}$: rampa \textbf{ascendente}

                    • Risultato: \textbf{onda triangolare}
                }}

                \vspace{0.15cm}
                \colorbox{yellow!30}{\parbox{0.95\linewidth}{
                    \textbf{$\bigstar$ Ampiezza onda triangolare:}

                    \vspace{0.05cm}
                    $$\boxed{V_{pp,tri} = \frac{V_{sat} \cdot T/2}{RC}}$$
                ...
                \vspace{0.05cm}
                \textit{Schema completo: collegare $V_{out,multivib}$ a $V_{in,integr}$}

            \end{minipage}
        };
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Generatore Forme d'Onda};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Generatore Forme d'Onda}{Generatore Forme d'Onda}}{Generatore Forme d'Onda}}{Generatore Forme d'Onda}}{Generatore Forme d'Onda}}
    \end{tikzpicture}
