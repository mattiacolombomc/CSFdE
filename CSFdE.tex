        ...
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \footnotesize
                    ...
                    \vspace{0.05cm}
                    • Il verso di $V_{OS}$ è arbitrario $\Rightarrow$ l'effetto finale è $\pm V_{OS} \cdot G_{ID}$

                    \vspace{0.05cm}
                    • Il contributo ha limite superiore e inferiore

                    \vspace{0.05cm}
                    • L'OpAmp resta ideale: $V^+ = V^-$ (in retroazione negativa)
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \vspace{0.1cm}
                • Le correnti possono essere \textbf{entranti} $(\downarrow)$ o \textbf{uscenti} $(\uparrow)$ dall'OpAmp
        ...
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \footnotesize
                    ...
                    \vspace{0.05cm}
                    • $I_{OS}$ è un contributo \textbf{statistico} $\Rightarrow$ l'effetto ha limite sup. e inf.

                    \vspace{0.05cm}
                    • I versi sono opposti per modellare l'asimmetria tra i due ingressi

                    \vspace{0.05cm}
                    • Si applica sovrapposizione come per $I_B$
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \vspace{0.1cm}
                $$\text{Errore} = V_{IN}\,(G_{ID} - G_{reale})$$

                \vspace{0.05cm}
                $$= V_{IN}\left(G_{ID} - \frac{G_{ID}}{1 - \frac{1}{G_{loop}}}\right)$$
                ...
                \vspace{0.1cm}
                $$\text{Errore}_{\text{MAX}} = V_{IN}\big|_{\text{MAX}} \cdot \frac{G_{ID}}{1 - G_{loop}(0)}$$
