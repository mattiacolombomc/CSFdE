        ...
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \begin{itemize}
                    ...
                    \item Periodo $T$ = tempo per completare un ciclo
                \end{itemize}


                \colorbox{cyan!20}{\parbox{0.95\linewidth}{\footnotesize
                        \textbf{DUTY CYCLE DEFAULT:} Se non specificato, un'onda quadra ha \textbf{duty cycle 50\%} (tempo HIGH = tempo LOW = $T/2$)
                    }}
                ...
                \colorbox{yellow!20}{\parbox{0.95\linewidth}{\small
                        ...
                        \begin{enumerate}
                            \item Traccia gli assi $t$ (orizzontale) e $V$ (verticale)
                ...
                \vspace{0.2cm}
                \colorbox{red!15}{\parbox{0.95\linewidth}{\small
                        \textbf{ERRORE COMUNE:} Non confondere il periodo $T$ con mezzo periodo!

                        \textbf{Trucco:} Conta i quadretti da dove l'onda \textit{inizia a salire} fino a dove \textit{ricomincia a salire} la seconda volta. Quello è $T$!
                    }}
