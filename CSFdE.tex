        ...
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \colorbox{green!20}{\parbox{0.95\linewidth}{
                    ...
                    \vspace{0.1cm}
                    Ad ogni nodo la corrente si \textbf{divide a met\`a}:

                    \vspace{0.05cm}
                    • 1 biforcazione: $I \to \frac{I}{2}$

                    • 2 biforcazioni: $I \to \frac{I}{4}$

                    • 3 biforcazioni: $I \to \frac{I}{8}$
                ...
                \colorbox{magenta!20}{\parbox{0.95\linewidth}{
                    ...
                    \vspace{0.1cm}
                    \textbf{LSB} (Least Significant Bit) = tensione del bit meno significativo:
                    $$\boxed{\text{LSB} = V_{out}(000...1) = I \cdot R_F}$$

                    \vspace{0.1cm}
                    \textbf{FSR} (Full Scale Range) = escursione massima:
                ...
                \vspace{0.15cm}
                \colorbox{orange!20}{\parbox{0.95\linewidth}{\footnotesize
                    \textbf{Nota:} Pi\`u biforcazioni $\Rightarrow$ corrente \textbf{esponenzialmente} pi\`u piccola

                    \vspace{0.05cm}
                    Questo permette la \textbf{pesatura binaria} dei bit!
                }}
