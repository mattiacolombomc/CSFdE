        ...
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \colorbox{cyan!20}{\parbox{0.95\linewidth}{
                    ...
                    \vspace{0.1cm}
                    $$\boxed{\text{DNL}_{ass}(i) = V_{out}(i) - V_{out}(i-1) - \text{LSB}}$$

                    \vspace{0.1cm}
                    \textbf{DNL Relativa} (in LSB):

                    \vspace{0.1cm}
                    $$\boxed{\text{DNL}_{rel}(i) = \frac{\text{DNL}_{ass}(i)}{\text{LSB}}}$$
                }}
        ...
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \colorbox{green!20}{\parbox{0.95\linewidth}{
                    ...
                    2. Trova $\text{DNL}_{ass} = V_{out,reale}(1) - V_{out,ideale}(1)$
