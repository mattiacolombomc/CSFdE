        ...
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \colorbox{green!20}{\parbox{0.95\linewidth}{
                    ...
                    $$\text{FSR} = V_{out}(111...1) = \text{LSB} \cdot (2^N - 1)$$
                }}
                ...
                \colorbox{yellow!30}{\parbox{0.95\linewidth}{
                    ...
                    \vspace{0.1cm}
                    $$\boxed{\text{LSB} = \frac{\text{FSR}}{2^N - 1}}$$
                }}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \vspace{0.15cm}
                Misura quanto ogni \textbf{step} della caratteristica reale si discosta dallo step ideale (1 LSB).
                ...
                \colorbox{cyan!20}{\parbox{0.95\linewidth}{
                    ...
                    \vspace{0.1cm}
                    Per ogni transizione da word $k$ a word $k+1$:
                    $$\boxed{\text{DNL}(k) = \frac{V_{out}(k+1) - V_{out}(k)}{\text{LSB}_{ideale}} - 1}$$

                    \vspace{0.05cm}
                    Espresso in \textbf{LSB ideali}
                }}
                ...
                \begin{center}
                    \begin{tikzpicture}[scale=0.6]
                        ...
                        % Caratteristica reale (punti)
                        \filldraw[blue] (0.5,0.5) circle (2pt);
                        \filldraw[blue] (1.5,1.6) circle (2pt);
                        \filldraw[blue] (2.5,2.3) circle (2pt);
                        \filldraw[blue] (3.5,3.4) circle (2pt);

                        % Step reali
                        \draw[blue, thick] (0.5,0.5) -- (1.5,0.5) -- (1.5,1.6);
                        \draw[blue, thick] (1.5,1.6) -- (2.5,1.6) -- (2.5,2.3);
                        \draw[blue, thick] (2.5,2.3) -- (3.5,2.3) -- (3.5,3.4);

                        % Annotazione DNL
                        \draw[<->, red, thick] (1.7,0.5) -- (1.7,1.6);
                        \node[red, anchor=west] at (1.8,1.05) {\tiny step reale};
                    \end{tikzpicture}
                \end{center}
                ...
                \colorbox{yellow!30}{\parbox{0.95\linewidth}{\footnotesize
                    ...
                    \vspace{0.05cm}
                    • DNL $= 0$ $\Rightarrow$ step perfetto (= 1 LSB)

                    • DNL $> 0$ $\Rightarrow$ step pi\`u grande del dovuto

                    • DNL $< 0$ $\Rightarrow$ step pi\`u piccolo del dovuto

                    • DNL $= -1$ $\Rightarrow$ \textbf{missing code} (step = 0)
                }}

            \end{minipage}
        };
        %------------ DAC DNL Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}DAC - DNL (Differential Non-Linearity)};
    \end{tikzpicture}
