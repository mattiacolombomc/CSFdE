...
\begin{multicols*}{3}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \colorbox{red!30}{\parbox{0.95\linewidth}{
                    \textbf{3. Intersezione con asse 0 dB: $G = 1$}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Formule Rapide di Navigazione sul Grafico};
    \end{tikzpicture}
        ...
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \colorbox{cyan!20}{\parbox{0.95\linewidth}{
                    ...
                    \vspace{0.1cm}
                    1. \textbf{Taglia l'anello} (apri il feedback)

                    2. Inserisci generatore di test $V_t$ nel punto di taglio

                    3. Calcola $V_x$ = tensione uscita dall'OpAmp

                    \vspace{0.1cm}
                    $$\boxed{G_{loop} = \frac{V_x}{V_t} = A(s) \cdot \beta}$$
