...
\begin{titlepage}
    ...
    {\Huge\bfseries Cheat Sheet}\\[0.5cm]
    {\Huge\bfseries Fondamenti di Elettronica}\\[2cm]

    \vfill

    {\large Creato da}\\[0.3cm]
    {\Large\bfseries Mattia Colombo}\\[0.3cm]
    \url{https://github.com/mattiacolombomc}\\[2cm]

    \vfill

    {\large Versione aggiornata: \today}
...
\begin{multicols*}{3}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Prefissi SI (Notazione Scientifica)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Prefissi SI (Notazione Scientifica)}{Prefissi SI (Notazione Scientifica)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{\color{blue}Generatori Spenti (Analisi Circuitale)}

                \vspace{0.2cm}
                \colorbox{cyan!20}{\parbox{0.95\linewidth}{
                    \textbf{Generatore di CORRENTE spento:}

                    \vspace{0.1cm}
                    \begin{center}
                    $I = 0$ $\Rightarrow$ \textbf{CIRCUITO APERTO}
                    \end{center}

                    \vspace{0.05cm}
                    (nessuna corrente $\Rightarrow$ ramo interrotto)
                }}

                \vspace{0.2cm}
                \colorbox{orange!25}{\parbox{0.95\linewidth}{
                    \textbf{Generatore di TENSIONE spento:}

                    \vspace{0.1cm}
                    \begin{center}
                    $V = 0$ $\Rightarrow$ \textbf{CORTOCIRCUITO}
                    \end{center}

                    \vspace{0.05cm}
                    (nessuna ddp $\Rightarrow$ filo ideale)
                }}

                \vspace{0.15cm}
                \footnotesize
                \textbf{Uso:} Calcolo $R_{eq}$ per $\tau$, sovrapposizione effetti, Thévenin/Norton.

            \end{minipage}
        };
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Generatori Spenti};
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{\color{blue}Equivalenze del Farad (Analisi Dimensionale)}

                \vspace{0.2cm}
                \colorbox{yellow!30}{\parbox{0.95\linewidth}{
                    \textbf{Definizione base:}
                    $$[F] = \frac{[C]}{[V]} = \frac{[A \cdot s]}{[V]}$$
                }}

                \vspace{0.15cm}
                \textbf{Equivalenze notevoli:}

                \vspace{0.1cm}
                \begin{tabular}{ll}
                    $[F] = \dfrac{[s]}{[\Omega]}$ & $\Leftarrow$ da $\tau = RC$ \\[0.4cm]
                    $[F] = \dfrac{[C]}{[V]}$ & $\Leftarrow$ da $Q = CV$ \\[0.4cm]
                    $[F] = \dfrac{[A]}{[V/s]}$ & $\Leftarrow$ da $I = C\dfrac{dV}{dt}$ \\[0.4cm]
                    $[F] = \dfrac{[J]}{[V^2]}$ & $\Leftarrow$ da $E = \frac{1}{2}CV^2$
                \end{tabular}

                \vspace{0.15cm}
                \colorbox{green!20}{\parbox{0.95\linewidth}{
                    \footnotesize
                    \textbf{Trucco:} Per verificare formule, controlla che le unità tornino!

                    Es: $\tau = RC \Rightarrow [\Omega][F] = [\Omega]\frac{[s]}{[\Omega]} = [s]$ \checkmark
                }}

            \end{minipage}
        };
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Equivalenze del Farad};
    \end{tikzpicture}
    ...
    \resizebox{\columnwidth}{0.9\textheight}{%------------ Box 26 ---------------
        ...
        \begin{tikzpicture}
            ...
            %------------ Box 26 Header ---------------------
            \node[fancytitle, right=10pt] at (box.north west) {\color{white}Procedimento transitori:};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Procedimento transitori:}{Procedimento transitori:}}
        \end{tikzpicture}}
    ...
    \begin{tikzpicture}
        ...
        %------------ Box 27 Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Grafico};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Grafico}{Grafico}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Condensatore - Carica/Scarica RC};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Condensatore - Carica/Scarica RC}{Condensatore - Carica/Scarica RC}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        %------------ Box 4 Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Resistenze e Alimentazioni};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Resistenze e Alimentazioni}{Resistenze e Alimentazioni}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ Box 3 Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Diodi};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Diodi}{Diodi}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Diodi - Esercizio Tipico (1/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Diodi - Esercizio Tipico (1/2)}{Diodi - Esercizio Tipico (1/2)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Diodi - Esercizio Tipico (2/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Diodi - Esercizio Tipico (2/2)}{Diodi - Esercizio Tipico (2/2)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Diodo + Condensatore};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Diodo + Condensatore}{Diodo + Condensatore}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Raddrizzatore Singola Semionda};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Raddrizzatore Singola Semionda}{Raddrizzatore Singola Semionda}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Rilevatore di Picco};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Rilevatore di Picco}{Rilevatore di Picco}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Alimentatore DC};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Alimentatore DC}{Alimentatore DC}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}RC + Diodo: Analisi STATICA};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{RC + Diodo: Analisi STATICA}{RC + Diodo: Analisi STATICA}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}RC + Diodo: Analisi DINAMICA (1/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{RC + Diodo: Analisi DINAMICA (1/2)}{RC + Diodo: Analisi DINAMICA (1/2)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}RC + Diodo: Analisi DINAMICA (2/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{RC + Diodo: Analisi DINAMICA (2/2)}{RC + Diodo: Analisi DINAMICA (2/2)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Potenza Dissipata - Diodo};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Potenza Dissipata - Diodo}{Potenza Dissipata - Diodo}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ Box 5 Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Capacità: Formule e Comportamento};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Capacità: Formule e Comportamento}{Capacità: Formule e Comportamento}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
            ...
            \begin{minipage}{0.3\textwidth}
                ...
                \begin{center}
                    \begin{tikzpicture}[scale=0.6, color=black]
                        ...
                        % Fase 1: a x=3.5 vale -3.5 + 2*(1-exp(-3)) ≈ -1.6
                        \draw[thick, green!50!black, domain=0.5:3.5, samples=50] plot (\x, {-3.5 + 2*(1-exp(-(\x-0.5)))});
                        % Fase 2: parte da -1.6, a x=3.8 vale -1.615
                        \draw[thick, orange, domain=3.5:3.8, samples=20] plot (\x, {-1.6 - 0.05*(\x-3.5)});
                        % Fase 3: parte da -1.615
                        \draw[thick, red!70!black, domain=3.8:7, samples=50] plot (\x, {-1.615 - 1.885*(1-exp(-(\x-3.8)))});
        ...
        %------------ Box 6 Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Transitori con gradini multipli};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Transitori con gradini multipli}{Transitori con gradini multipli}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
                ...
                \small
                        ...
                        \begin{center}
                            \begin{circuitikz}[scale=0.65, color=black]
                                ...
                                \draw[->, very thick, color=orange, line width=1.2pt] (4.5,4.1) -- (0.5,4.1);
                                \node[anchor=south, color=orange] at (2.5,4.3) {\small $I$ (5V$\to$0V)};
        ...
        %------------ Box 7 Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Verifica ipotesi stato diodi};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Verifica ipotesi stato diodi}{Verifica ipotesi stato diodi}}
    \end{tikzpicture}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{tikzpicture}
        ...
        %------------ Box 8 Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Notazione alimentazioni};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Notazione alimentazioni}{Notazione alimentazioni}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Onda Quadra Ideale - Guida al Disegno};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Onda Quadra Ideale - Guida al Disegno}{Onda Quadra Ideale - Guida al Disegno}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Formazione del Canale nei MOSFET};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Formazione del Canale nei MOSFET}{Formazione del Canale nei MOSFET}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \vspace{0.3cm}
                \colorbox{green!20}{\parbox{0.95\linewidth}{
                    \textbf{Mnemonico per S/D a runtime:}
                    \begin{itemize}[itemsep=1pt, leftmargin=*]
                        \item \textbf{pMOS}: corrente S $\to$ D (intuitivo: dalla "sorgente" al "consumatore")
                        \item \textbf{nMOS}: corrente D $\to$ S (controintuitivo)
                    \end{itemize}
                    Sapendo che $I$ scorre da $V_{alta} \to V_{bassa}$, una volta nota la direzione della corrente (es. carica/scarica C in logica CMOS), si attribuiscono S e D di conseguenza.
                }}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Simboli e convenzioni nMOS/pMOS};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Simboli e convenzioni nMOS/pMOS}{Simboli e convenzioni nMOS/pMOS}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Caratteristica I-V nMOS};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Caratteristica I-V nMOS}{Caratteristica I-V nMOS}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Caratteristica I-V pMOS};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Caratteristica I-V pMOS}{Caratteristica I-V pMOS}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ Box nMOS Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}nMOS - Metodo operativo};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{nMOS - Metodo operativo}{nMOS - Metodo operativo}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ Box pMOS Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}pMOS - Metodo operativo};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{pMOS - Metodo operativo}{pMOS - Metodo operativo}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}pMOS - Formule $V_{SG}$/$V_{SD}$};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{pMOS - Formule /}{pMOS - Formule /}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Riepilogo: nMOS vs pMOS};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Riepilogo: nMOS vs pMOS}{Riepilogo: nMOS vs pMOS}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}MOSFET simmetrici - Source e Drain a runtime};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{MOSFET simmetrici - Source e Drain a runtime}{MOSFET simmetrici - Source e Drain a runtime}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Regola pratica - MOSFET ON/OFF veloce};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Regola pratica - MOSFET ON/OFF veloce}{Regola pratica - MOSFET ON/OFF veloce}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ Overdrive Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Parametro K (Transconduttanza)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Parametro K (Transconduttanza)}{Parametro K (Transconduttanza)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Semplificazioni MOSFET};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Semplificazioni MOSFET}{Semplificazioni MOSFET}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Analisi Porte Logiche};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Analisi Porte Logiche}{Analisi Porte Logiche}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Resistenza di canale};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Resistenza di canale}{Resistenza di canale}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Carica di un condensatore con MOSFET};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Carica di un condensatore con MOSFET}{Carica di un condensatore con MOSFET}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Scarica di un condensatore con MOSFET};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Scarica di un condensatore con MOSFET}{Scarica di un condensatore con MOSFET}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Valutazione logica circuiti ibridi/intermedi (PTL)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Valutazione logica circuiti ibridi/intermedi (PTL)}{Valutazione logica circuiti ibridi/intermedi (PTL)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \footnotesize
                \textbf{\color{blue}Tempo di Propagazione - Algoritmo}

                \vspace{0.1cm}
                \begin{minipage}{0.48\linewidth}
                \begin{tikzpicture}[scale=0.6]
                    \draw[->] (0,0) -- (4.2,0) node[right] {\tiny $|V_{DS}|$};
                    \draw[->] (0,0) -- (0,2.3) node[above] {\tiny $|I_{DS}|$};
                    \draw[thick, blue] (0,0) parabola[bend at end] (1.2,1.8);
                    \draw[thick, blue] (1.2,1.8) -- (3.8,1.8);
                    \draw[dashed, gray] (1.2,0) -- (1.2,1.8);
                    \node[below, font=\tiny] at (1.2,-0.1) {$V_{pinch}$};
                    \node[font=\tiny, blue] at (0.45,1.1) {Ohm};
                    \node[font=\tiny, blue] at (2.5,2.05) {Sat};
                    \filldraw[red] (3.3,1.8) circle (1.5pt) node[above, font=\tiny] {$V_{start}$};
                    \filldraw[red] (0.5,1.0) circle (1.5pt) node[below, font=\tiny] {$V_{end}$};
                    \draw[->, red, thick] (3.1,1.7) -- (0.7,1.1);
                \end{tikzpicture}
                \end{minipage}%
                \begin{minipage}{0.52\linewidth}
                \scriptsize
                \textbf{1. Dati preliminari}

                $\bullet$ $V_{pinch} = V_{GS} - V_T$

                $\bullet$ $I_{sat} = K(V_{GS}-V_T)^2$

                $\bullet$ $R_{eq} = \frac{1}{K(V_{GS}-V_T)}$

                \vspace{0.05cm}
                {\tiny (pMOS: usa $|V_{GS}| - |V_T|$)}
                \end{minipage}
                ...
                \scriptsize
                \textbf{2. DECISION TREE} -- Confronta $[V_{start}, V_{end}]$ con $V_{pinch}$:

                \vspace{0.1cm}
                \textbf{\underline{CASO A: Solo SAT}} ($V_{start}$ e $V_{end} > V_{pinch}$)

                MOS = generatore $I_{sat}$ $\Rightarrow$ $\boxed{\Delta t = \frac{C_L \cdot (V_{start} - V_{end})}{I_{sat}}}$

                \vspace{0.1cm}
                \textbf{\underline{CASO B: Solo OHMICA}} ($V_{start}$ e $V_{end} < V_{pinch}$)

                MOS = resistore $\Rightarrow$ $\boxed{\Delta t = R \cdot C_L \cdot \ln\!\left( \frac{V_{start}}{V_{end}} \right)}$

                {\tiny Quale R? Vicino a 0V: $R_{DS,on} = \frac{R_{eq}}{2}$. Appena sotto pinch: $R_{eq}$.}

                \vspace{0.1cm}
                \textbf{\underline{CASO C: MISTA}} ($V_{start} > V_{pinch} > V_{end}$)

                $\Rightarrow$ \textbf{Vedi box successiva!} (split sat + ohmica)

            \end{minipage}
        };
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Tempo di Propagazione};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Tempo di Propagazione}{Tempo di Propagazione}}
    \end{tikzpicture}

    \vspace{0.3cm}

    %------------ Tempo di propagazione - Caso C Misto ---------------
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}

                \footnotesize
                \textbf{\color{blue}$t_p$ - CASO C: Transizione Mista (Split)}

                \vspace{0.1cm}
                Quando $V_{start} > V_{pinch} > V_{end}$: calcola \textbf{due tempi} e sommali.

                \vspace{0.15cm}
                \textbf{\underline{1. Tempo in Saturazione ($t_{sat}$)}}

                Da $V_{start}$ a $V_{pinch}$, corrente costante $I_{sat}$:
                $$\boxed{t_{sat} = \frac{C_L \cdot (V_{start} - V_{pinch})}{I_{sat}}}$$

                \vspace{0.1cm}
                \textbf{\underline{2. Tempo in Ohmica ($t_{ohm}$)}}

                Da $V_{pinch}$ a $V_{end}$, scarica RC con $R_{eq}$:
                $$\boxed{t_{ohm} = R_{eq} \cdot C_L \cdot \ln\!\left( \frac{V_{pinch}}{V_{end}} \right)}$$

                \vspace{0.1cm}
                \textbf{\underline{3. Tempo Totale}}
                $$\boxed{t_{tot} = t_{sat} + t_{ohm}}$$
                ...
                \scriptsize
                \textbf{Esempio:} Scarica da 4V a 2V con $V_{pinch}=3V$

                $\bullet$ $t_{sat}$: da 4V a 3V con $I_{sat}$ (corrente)

                $\bullet$ $t_{ohm}$: da 3V a 2V con $R_{eq}$ (logaritmo)

                $\bullet$ $t_{tot} = t_{sat} + t_{ohm}$

            \end{minipage}
        };
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}$t_p$ - Caso Misto (Split)};
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ PTL vs CMOS Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}PTL vs CMOS Logic};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{PTL vs CMOS Logic}{PTL vs CMOS Logic}}
    \end{tikzpicture}
    ...
    \textit{Nota:} Metodo 1 sovrastima il ritardo, Metodo 2 lo sottostima.
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Tempo di propagazione - PTL};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Tempo di propagazione - PTL}{Tempo di propagazione - PTL}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Riconoscere circuiti PTL};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Riconoscere circuiti PTL}{Riconoscere circuiti PTL}}
    \end{tikzpicture}

    \vspace{0.3cm}

    %------------ Cross-conduzione vs Limitazione PTL ---------------
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \begin{tabular}{|p{2.5cm}|p{2.5cm}|}
                    \hline
                    \textbf{Cross-conduzione (CMOS)} & \textbf{Limitazione (PTL)} \\
                    \hline
                ...
                \footnotesize
                    ...
                    \textbf{Cross-conduzione} = tiro alla fune (entrambi tirano, corrente continua)
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Cross-conduzione (CMOS) vs Limitazione (PTL)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Cross-conduzione (CMOS) vs Limitazione (PTL)}{Cross-conduzione (CMOS) vs Limitazione (PTL)}}
    \end{tikzpicture}
...
\begin{tikzpicture}
    ...
    \node[fancytitle, right=10pt] at (box.north west) {\color{white}Soglia Logica CMOS vs. PTL};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Soglia Logica CMOS vs. PTL}{Soglia Logica CMOS vs. PTL}}
\end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Tabella di Verità - Circuiti PTL};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Tabella di Verità - Circuiti PTL}{Tabella di Verità - Circuiti PTL}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \vspace{0.2cm}
                \textbf{cMOS complementare:} $P_{statica} = 0$ sempre (mai cross-conduzione).

                \vspace{0.1cm}
                \textbf{cMOS non complementare:} $P_{statica} \neq 0$ quando c'è \textbf{cross-conduzione} (uscita a valore intermedio, non $V_{DD}$ né GND).

                \vspace{0.2cm}
                \footnotesize
                    \textbf{$\triangle$ Regola:} Si consuma potenza statica \textbf{solo} quando l'uscita NON è a $V_{DD}$ o GND (= cross-conduzione, cammino DC da $V_{DD}$ a GND).

                    \vspace{0.1cm}
                    \textbf{Formula con duty cycle:}
                    $$\boxed{P_{stat} = V_{DD} \cdot I_{sat} \cdot \frac{T_{cross-conduzione}}{T_{periodo}}}$$

                    Dove $T_{cross-conduzione}$ = tempo totale in un periodo in cui l'uscita è a un livello intermedio.

                    $I_{sat}$ = corrente del MOS in saturazione durante cross-conduzione.
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Potenza statica};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Potenza statica}{Potenza statica}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Potenza dinamica - Formula};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Potenza dinamica - Formula}{Potenza dinamica - Formula}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Potenza dinamica - Calcolo da grafico};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Potenza dinamica - Calcolo da grafico}{Potenza dinamica - Calcolo da grafico}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ Duty Cycle Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Duty Cycle};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Duty Cycle}{Duty Cycle}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Prestazioni e $f_{max}$};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Prestazioni e}{Prestazioni e}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ cMOS Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Porte cMOS - Definizione};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Porte cMOS - Definizione}{Porte cMOS - Definizione}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Costruzione PUN da PDN};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Costruzione PUN da PDN}{Costruzione PUN da PDN}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Invertitore nMOS con $R_L$};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Invertitore nMOS con}{Invertitore nMOS con}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture} 
            ...
            \begin{minipage}{0.3\textwidth}
                ...
                \vspace{0.15cm}
                    ...
                    \begin{tabular}{|c|c|c|}
                        ...
                        \hline
                        Percorso & Percorso & \textbf{Cross-conduzione!} \\
                        \hline
                    \end{tabular}

                    \vspace{0.1cm}
                    {\footnotesize \textbf{Cross-conduzione $\neq$ cortocircuito ideale!}
                    ...
                    $\Rightarrow$ Vedi box ``Cross-conduzione PUN/PDN''}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}GUIDA - Tabella di Verità Reti CMOS};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{GUIDA - Tabella di Verità Reti CMOS}{GUIDA - Tabella di Verità Reti CMOS}}
    \end{tikzpicture}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Livelli di Tensione e Soglia Logica};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Livelli di Tensione e Soglia Logica}{Livelli di Tensione e Soglia Logica}}
    \end{tikzpicture}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Riconoscere Rete cMOS Completa};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Riconoscere Rete cMOS Completa}{Riconoscere Rete cMOS Completa}}
    \end{tikzpicture}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{tikzpicture}
            ...
            \begin{minipage}{0.3\textwidth}
                ...
                \vspace{0.15cm}
                    ...
                    \begin{tabular}{|l|l|}
                        ...
                        Solo PDN ON & $0V$ \\
                        \hline
                        Entrambe ON & \textbf{Cross-conduzione} $\Rightarrow$ Step 3 \\
                        \hline
                ...
                \vspace{0.15cm}
                    ...
                    \textbf{$\bigstar$ STEP 3: Calcolo valore cross-conduzione}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Complementare vs Non Complementare --- Cosa Fare};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Complementare vs Non Complementare --- Cosa Fare}{Complementare vs Non Complementare --- Cosa Fare}}
    \end{tikzpicture}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

    \newpage
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %------------ Cross-conduzione PUN/PDN - Teoria ---------------
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{Cross-conduzione: PUN e PDN entrambe ON}
                ...
                \vspace{0.15cm}
                \footnotesize
                    \textbf{$\triangle$ SOSTITUZIONE RAPIDA} (nei calcoli di cross-conduzione):
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Cross-conduzione PUN/PDN - Teoria};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Cross-conduzione PUN/PDN - Teoria}{Cross-conduzione PUN/PDN - Teoria}}
    \end{tikzpicture}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %------------ Cross-conduzione PUN/PDN - Metodi di Calcolo ---------------
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{Cross-conduzione: Metodi di Calcolo $V_{OL}$/$V_{OH}$}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Cross-conduzione PUN/PDN - Calcolo};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Cross-conduzione PUN/PDN - Calcolo}{Cross-conduzione PUN/PDN - Calcolo}}
    \end{tikzpicture}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \vspace{0.15cm}
                    ...
                    \textbf{$\bigstar$ APPLICAZIONE ALLA CROSS-CONDUZIONE:}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}$R_{DS,on}$ --- Riepilogo Formule};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{--- Riepilogo Formule}{--- Riepilogo Formule}}
    \end{tikzpicture}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Soglia Logica della Porta ($V_M$)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Soglia Logica della Porta ()}{Soglia Logica della Porta ()}}
    \end{tikzpicture}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Introduzione e Caratteristica};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Introduzione e Caratteristica}{OpAmp - Introduzione e Caratteristica}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Impedenza con Condensatori};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Impedenza con Condensatori}{Impedenza con Condensatori}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Forma Standard per Bode};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Forma Standard per Bode}{Forma Standard per Bode}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ Bode Modulo Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Bode - Diagramma del Modulo};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Bode - Diagramma del Modulo}{Bode - Diagramma del Modulo}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Bode - Metodo Generale Unificato};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Bode - Metodo Generale Unificato}{Bode - Metodo Generale Unificato}}
    \end{tikzpicture}}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Formule Rapide di Navigazione sul Bode};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Formule Rapide di Navigazione sul Bode}{Formule Rapide di Navigazione sul Bode}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Bode - Singolarità in Zero ($n \neq 0$)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Bode - Singolarità in Zero ()}{Bode - Singolarità in Zero ()}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ Bode Fase Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Bode - Diagramma della Fase};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Bode - Diagramma della Fase}{Bode - Diagramma della Fase}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Intersezione 0 dB in Bode};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Intersezione 0 dB in Bode}{Intersezione 0 dB in Bode}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Calcolo Guadagno a Frequenze Specifiche};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Calcolo Guadagno a Frequenze Specifiche}{Calcolo Guadagno a Frequenze Specifiche}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Bode - Polo e Zero Coincidenti};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Bode - Polo e Zero Coincidenti}{Bode - Polo e Zero Coincidenti}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Guadagno Reale vs Ideale};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Guadagno Reale vs Ideale}{Guadagno Reale vs Ideale}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Guadagno Reale - Intersezioni};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Guadagno Reale - Intersezioni}{Guadagno Reale - Intersezioni}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Margine di Fase e Stabilit\`a};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Margine di Fase e Stabilit\`a}{Margine di Fase e Stabilit\`a}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Stabilit\`a - Senza Crossover};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Stabilit\`a - Senza Crossover}{Stabilit\`a - Senza Crossover}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Stabilit\`a - Segno di $G_{loop}$};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Stabilit\`a - Segno di}{Stabilit\`a - Segno di}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Quando fare il Bode di $G_{loop}$};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Quando fare il Bode di}{Quando fare il Bode di}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Retroazione e Saturazione};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Retroazione e Saturazione}{OpAmp - Retroazione e Saturazione}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Riconoscere Configurazione};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Riconoscere Configurazione}{OpAmp - Riconoscere Configurazione}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Saturazione dell'Uscita};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Saturazione dell'Uscita}{OpAmp - Saturazione dell'Uscita}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp Rail-to-Rail};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp Rail-to-Rail}{OpAmp Rail-to-Rail}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Retroazione Negativa};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Retroazione Negativa}{OpAmp - Retroazione Negativa}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Riconoscimento Rapido};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Riconoscimento Rapido}{OpAmp - Riconoscimento Rapido}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Non idealità: Tensione di Offset};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Non idealità: Tensione di Offset}{OpAmp - Non idealità: Tensione di Offset}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Non idealità: Correnti di Bias};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Non idealità: Correnti di Bias}{OpAmp - Non idealità: Correnti di Bias}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Non idealità: Correnti di Offset};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Non idealità: Correnti di Offset}{OpAmp - Non idealità: Correnti di Offset}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Non idealità: Slew Rate};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Non idealità: Slew Rate}{OpAmp - Non idealità: Slew Rate}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Non idealità: Errore Statico di Guadagno};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Non idealità: Errore Statico di Guadagno}{OpAmp - Non idealità: Errore Statico di Guadagno}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Risposta al Gradino - Sistema 1$^\circ$ Ordine};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Risposta al Gradino - Sistema 1 Ordine}{Risposta al Gradino - Sistema 1 Ordine}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp - Analisi Dinamica};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp - Analisi Dinamica}{OpAmp - Analisi Dinamica}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}OpAmp Non Compensato - Stabilità};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{OpAmp Non Compensato - Stabilità}{OpAmp Non Compensato - Stabilità}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Integratore OpAmp - Ideale};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Integratore OpAmp - Ideale}{Integratore OpAmp - Ideale}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Integratore Reale - Problema $I_B$};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Integratore Reale - Problema}{Integratore Reale - Problema}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ DAC R2R Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}DAC R-2R (Resistor Ladder)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{DAC R-2R (Resistor Ladder)}{DAC R-2R (Resistor Ladder)}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}DAC R-2R - Deviatori e $V_{out}$};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{DAC R-2R - Deviatori e}{DAC R-2R - Deviatori e}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ DAC FSR LSB Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}DAC - FSR e LSB};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{DAC - FSR e LSB}{DAC - FSR e LSB}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ DAC DNL Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}DAC - DNL (1/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{DAC - DNL (1/2)}{DAC - DNL (1/2)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ DAC DNL Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}DAC - DNL (2/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{DAC - DNL (2/2)}{DAC - DNL (2/2)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        %------------ DAC Dinamica Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}DAC - Dinamica Transizioni (OpAmp reale)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{DAC - Dinamica Transizioni (OpAmp reale)}{DAC - Dinamica Transizioni (OpAmp reale)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}DAC a Correnti Pesate};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{DAC a Correnti Pesate}{DAC a Correnti Pesate}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}DAC Correnti Pesate - Deviatori};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{DAC Correnti Pesate - Deviatori}{DAC Correnti Pesate - Deviatori}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}DAC Correnti Pesate - DNL};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{DAC Correnti Pesate - DNL}{DAC Correnti Pesate - DNL}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}DAC Correnti Pesate - Dinamica};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{DAC Correnti Pesate - Dinamica}{DAC Correnti Pesate - Dinamica}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Comparatore a Singola Soglia};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Comparatore a Singola Soglia}{Comparatore a Singola Soglia}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \begin{tikzpicture}
                    % Paths, nodes and wires:
                    \node[op amp, yscale=-1](OpAmp) at (7.56, 6.75){};
                    \draw (4, 7.25) to[american resistor] (6.37, 7.24);
                    \draw (6.37, 6.26) to[american voltage source] (6.37, 4.51);
                    \draw (6.25, 8.5) to[american resistor] (8.25, 8.5);
                    \draw (6.25, 8.5) -- (6.25, 7.25);
                    \draw (8.75, 6.75) -- (10.25, 6.75) -- (10.25, 8.5) -- (8.25, 8.5);
                    \node[shape=rectangle, minimum width=0.965cm, minimum height=0.715cm](N1) at (7.5, 9){} node[anchor=center] at (N1.text){$R_2$};
                    \node[shape=rectangle, minimum width=0.965cm, minimum height=0.715cm](N2) at (5, 7.875){} node[anchor=center] at (N2.text){$R_{1}$};
                    \node[ground] at (6.37, 4.51){};
                    \node[shape=rectangle, minimum width=0.965cm, minimum height=0.715cm](N3) at (11.25, 6.625){} node[anchor=center] at (N3.text){$V_{out}$};
                    \draw (10.25, 6.75) -- (10.75, 6.75);
                    \node[shape=rectangle, minimum width=0.965cm, minimum height=0.715cm](N4) at (5.5, 5.375){} node[anchor=center] at (N4.text){$V_{in}$};
                ...
                \begin{tikzpicture}
                    ...
                    \node[shape=rectangle, minimum width=0.965cm, minimum height=0.715cm](N3) at (11.25, 6.625){} node[anchor=center] at (N3.text){$V_{out}$};
                    \draw (10.25, 6.75) -- (10.75, 6.75);
                    \node[shape=rectangle, minimum width=0.965cm, minimum height=0.715cm](N4) at (3.13, 6.365){} node[anchor=center] at (N4.text){$V_{in}$};
                    \node[ground] at (6.37, 6.26){};
                \end{tikzpicture}%
                }
                \end{center}
    ...
    %------------ Comparatore a Doppia Soglia - Regole ---------------
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{Trigger di Schmitt - Regole Fondamentali}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Trigger di Schmitt - Regole Fondamentali};
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Trigger di Schmitt - Tabella Comparativa};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Trigger di Schmitt - Tabella Comparativa}{Trigger di Schmitt - Tabella Comparativa}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Comparatore - Rumore vs Isteresi};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Comparatore - Rumore vs Isteresi}{Comparatore - Rumore vs Isteresi}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Trigger di Schmitt - Funzionamento};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Trigger di Schmitt - Funzionamento}{Trigger di Schmitt - Funzionamento}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Trigger di Schmitt - Caratteristica};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Trigger di Schmitt - Caratteristica}{Trigger di Schmitt - Caratteristica}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Trigger di Schmitt - Calcolo Soglie};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Trigger di Schmitt - Calcolo Soglie}{Trigger di Schmitt - Calcolo Soglie}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Trigger di Schmitt - Metodo Calcolo Soglie};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Trigger di Schmitt - Metodo Calcolo Soglie}{Trigger di Schmitt - Metodo Calcolo Soglie}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Trigger di Schmitt - Grafici Isteresi};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Trigger di Schmitt - Grafici Isteresi}{Trigger di Schmitt - Grafici Isteresi}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Trigger di Schmitt - Regole Isteresi};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Trigger di Schmitt - Regole Isteresi}{Trigger di Schmitt - Regole Isteresi}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Introduzione};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Introduzione}{ADC - Introduzione}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Catena di Acquisizione};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Catena di Acquisizione}{Catena di Acquisizione}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Sample \& Hold};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Sample e Hold}{Sample e Hold}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \vspace{0.15cm}
                \begin{center}
                    \includegraphics[width=0.9\linewidth]{SampleAndHold.jpg}
                \end{center}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Sample \& Hold con Buffer};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Sample e Hold con Buffer}{Sample e Hold con Buffer}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Buffer - Dimensionamento Dinamico};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Buffer - Dimensionamento Dinamico}{Buffer - Dimensionamento Dinamico}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Adattamento e Dinamica};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Adattamento e Dinamica}{ADC - Adattamento e Dinamica}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Metodo Calcolo $V_{REF}$};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Metodo Calcolo}{ADC - Metodo Calcolo}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Buffer e Errore Statico};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Buffer e Errore Statico}{ADC - Buffer e Errore Statico}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Richieste Tipiche d'Esame};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Richieste Tipiche d'Esame}{ADC - Richieste Tipiche d'Esame}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Altre Richieste Esame};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Altre Richieste Esame}{ADC - Altre Richieste Esame}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Errore da $I_B$ nel S\&H};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Errore da  nel SeH}{ADC - Errore da  nel SeH}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}S\&H - Comando nMOS};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{SeH - Comando nMOS}{SeH - Comando nMOS}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}S\&H - Charge Injection (Teoria)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{SeH - Charge Injection (Teoria)}{SeH - Charge Injection (Teoria)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}S\&H - Charge Injection (Calcoli)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{SeH - Charge Injection (Calcoli)}{SeH - Charge Injection (Calcoli)}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - LSB all'Ingresso e Numero di Bit};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - LSB all'Ingresso e Numero di Bit}{ADC - LSB all'Ingresso e Numero di Bit}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Tempi di Sample e Hold};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Tempi di Sample e Hold}{ADC - Tempi di Sample e Hold}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Risposta con Guadagno $A(s)$};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Risposta con Guadagno}{ADC - Risposta con Guadagno}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Dimens. $V_B$ e Errore Fondo Scala};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Dimens.  e Errore Fondo Scala}{ADC - Dimens.  e Errore Fondo Scala}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - SAR (Successive Approximation)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - SAR (Successive Approximation)}{ADC - SAR (Successive Approximation)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Doppia Rampa (Dual Slope)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Doppia Rampa (Dual Slope)}{ADC - Doppia Rampa (Dual Slope)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Singola Rampa (A Gradinata)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Singola Rampa (A Gradinata)}{ADC - Singola Rampa (A Gradinata)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Inseguimento (Tracking)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Inseguimento (Tracking)}{ADC - Inseguimento (Tracking)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC - Terminologia};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC - Terminologia}{ADC - Terminologia}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}GUIDA - Riconoscere Configurazioni (1/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{GUIDA - Riconoscere Configurazioni (1/2)}{GUIDA - Riconoscere Configurazioni (1/2)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}GUIDA - Riconoscere Configurazioni (2/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{GUIDA - Riconoscere Configurazioni (2/2)}{GUIDA - Riconoscere Configurazioni (2/2)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{Multivibratore Astabile - Circuito}
                ...
                \begin{tikzpicture}
                    ...
                    \draw (4, 7.25) to[american resistor] (6.37, 7.24);
                    \draw (6.25, 8.5) -- (6.25, 7.25);
                    \node[shape=rectangle, minimum width=0.965cm, minimum height=0.715cm](N1) at (8, 9){} node[anchor=center] at (N1.text){$R_2$};
                    \node[shape=rectangle, minimum width=0.965cm, minimum height=0.715cm](N2) at (5, 7.875){} node[anchor=center] at (N2.text){$R_{1}$};
                    \node[shape=rectangle, minimum width=0.965cm, minimum height=0.715cm](N3) at (11.25, 6.625){} node[anchor=center] at (N3.text){$V_{out}$};
                    \draw (10.25, 6.75) -- (10.75, 6.75);
                    \draw (6.25, 8.5) to[american resistor] (9.75, 8.5);
                    \draw (9.75, 8.5) -| (9.75, 6.75) -- (10.25, 6.75) -- (8.75, 6.75);
                    \draw (4.5, 5.25) to[capacitor] (5.5, 5.25);
                    \node[shape=rectangle, minimum width=0.965cm, minimum height=0.715cm](N4) at (5, 4.375){} node[anchor=center] at (N4.text){$C$};
                    \node[ground, rotate=-90] at (4.5, 5.25){};
                    \node[ground, rotate=-90] at (4, 7.25){};
                    \draw (6.37, 6.26) |- (5.5, 6.25) -- (5.5, 5.25);
                    \draw (9.75, 6.75) |- (7.75, 5.25);
                    \draw (7.75, 5.25) to[american resistor] (6.5, 5.25);
                    \draw (6.5, 5.25) -- (5.5, 5.25);
                    \node[shape=rectangle, minimum width=0.965cm, minimum height=0.715cm](N5) at (7.25, 4.625){} node[anchor=center] at (N5.text){$R$};
                    \node[circ] at (9.75, 6.75){};
                    \node[circ] at (5.5, 5.25){};
                    \node[circ] at (6.25, 7.25){};
                    \node[circ] at (10.75, 6.75){};
                \end{tikzpicture}%
                }
                \end{center}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Multivibratore Astabile - Circuito};
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Multivibratore Astabile (1/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Multivibratore Astabile (1/2)}{Multivibratore Astabile (1/2)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Multivibratore - Forme d'Onda};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Multivibratore - Forme d'Onda}{Multivibratore - Forme d'Onda}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Multivibratore Astabile (2/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Multivibratore Astabile (2/2)}{Multivibratore Astabile (2/2)}}
    \end{tikzpicture}%
    }
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Multivibratore - Commutazione};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Multivibratore - Commutazione}{Multivibratore - Commutazione}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Multivibratore Astabile - Esame (1/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Multivibratore Astabile - Esame (1/2)}{Multivibratore Astabile - Esame (1/2)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Multivibratore Astabile - Esame (2/2)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Multivibratore Astabile - Esame (2/2)}{Multivibratore Astabile - Esame (2/2)}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Generatore Forme d'Onda};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Generatore Forme d'Onda}{Generatore Forme d'Onda}}
    \end{tikzpicture}
