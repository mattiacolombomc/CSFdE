...
\end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Comparatore a Doppia Soglia (Isteresi)};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Comparatore a Doppia Soglia (Isteresi)}{Comparatore a Doppia Soglia (Isteresi)}}
    \end{tikzpicture}%
    }
