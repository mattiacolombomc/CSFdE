...
\end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}S\&H - Charge Injection};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{SeH - Charge Injection}{SeH - Charge Injection}}
    \end{tikzpicture}%
    }
