        ...
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \colorbox{red!20}{\parbox{0.95\linewidth}{\footnotesize
                    ...
                    La tensione massima/minima raggiungibile sul condensatore dipende dal \textbf{tipo di MOSFET}!
                }}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \textbf{\underline{VALUTAZIONE LOGICA nei circuiti IBRIDI/INTERMEDI}}
                ...
                \vspace{0.15cm}
                \colorbox{green!15}{\parbox{0.95\linewidth}{\tiny
                    \textbf{Nota importante:} Questa valutazione si usa SOLO per le \textbf{tabelle di verità} dei circuiti ibridi. Nei circuiti cMOS completi, l'uscita raggiunge sempre $V_{DD}$ o GND.
                }}

            \end{minipage}
        };
        %------------ Scarica condensatore Header ---------------------
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Scarica di un condensatore con MOSFET + Valutazione logica PTL};
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \vspace{0.1cm}
                \colorbox{purple!20}{\parbox{0.95\linewidth}{\footnotesize
                    \textbf{Struttura:}
    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \small
                \textbf{\color{blue}Tempo di propagazione in PTL (Pass Transistor Logic)}
                ...
                \colorbox{green!15}{\parbox{0.95\linewidth}{\tiny
                    ...
                    \vspace{0.03cm}
                    $\tau_{prop} = 0.69 \cdot 125 \cdot 10 \cdot 10^{-12} = 0.86$ ns
                }}
        ...
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \colorbox{purple!15}{\parbox{0.95\linewidth}{\footnotesize
                    \textbf{Duty Cycle (ciclo di lavoro):}

                    \vspace{0.05cm}
                    Il \textbf{duty cycle} $\delta$ è il rapporto tra il tempo in cui il segnale è HIGH e il periodo totale:
                    ...
                    \vspace{0.1cm}
                    \textbf{Relazione con la potenza:}
