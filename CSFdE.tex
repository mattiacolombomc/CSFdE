...
\end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Prestazioni e $f_{max}$};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Prestazioni e fmax}{Prestazioni e fmax}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}Invertitore nMOS con $R_L$};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{Invertitore nMOS con RL}{Invertitore nMOS con RL}}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \node[fancytitle, right=10pt] at (box.north west) {\color{white}ADC a Doppia Rampa};\phantomsection\addcontentsline{toc}{subsection}{\texorpdfstring{ADC a Doppia Rampa}{ADC a Doppia Rampa}}
    \end{tikzpicture}
