    ...
    \begin{tikzpicture}
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \vspace{0.1cm}
                $$Z_C(j\omega) = \frac{1}{j\omega C} = \frac{-j}{\omega C}$$

                Con modulo: $|Z_C| = \frac{1}{\omega C}$ e fase: $\angle Z_C = -90^\circ$

                \vspace{0.2cm}
                \colorbox{yellow!30}{\parbox{0.95\linewidth}{\footnotesize
                    \textbf{\color{orange}$\bigstar$ CONDENSATORE IN DC (Corrente Continua)}

                    \vspace{0.05cm}
                    Quando $\omega = 0$ (DC) → $|Z_C| \to \infty$

                    \vspace{0.05cm}
                    \textbf{Il condensatore diventa un APERTO}

                    \vspace{0.05cm}
                    • Con ingressi costanti (DC)

                    • In sovrapposizione degli effetti con generatori costanti

                    • Considera C come circuito aperto
                }}
                ...
                \vspace{0.05cm}
                $$Z(j\omega) = \frac{R \cdot \frac{1}{j\omega C}}{R + \frac{1}{j\omega C}} = \frac{R}{1 + j\omega RC}$$
        ...
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \colorbox{orange!20}{\parbox{0.95\linewidth}{\footnotesize
                    ...
                    \vspace{0.05cm}
                    • Se $n \neq 0$: \textbf{NON puoi} calcolare a $s=0$ (singolarità!)

                    \vspace{0.05cm}
                    \textit{Caso con singolarità in zero: sezione da completare dopo spiegazione del professore}
                }}
