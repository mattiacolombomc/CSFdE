        ...
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \colorbox{red!25}{\parbox{0.95\linewidth}{
                    ...
                    \vspace{0.1cm}
                    Per ogni combinazione di ingressi (A, B, C...):

                    \vspace{0.05cm}
                    \textbf{1.} Determina quali MOSFET sono \textbf{ON/OFF}

                    \textbf{2.} Verifica se esiste \textbf{percorso} da $V_{DD}$ a OUT (PUN)

                    \textbf{3.} Verifica se esiste \textbf{percorso} da GND a OUT (PDN)

                    \textbf{4.} Determina l'uscita in base ai percorsi attivi
                }}
        ...
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \colorbox{green!25}{\parbox{0.95\linewidth}{
                    ...
                    \quad Sat: $I_n = \frac{K_n}{2}(V_{GS,n} - V_{Tn})^2$

                    \quad Ohm: $I_n = K_n\left[(V_{GS,n} - V_{Tn})V_{DS,n} - \frac{V_{DS,n}^2}{2}\right]$

                    \vspace{0.05cm}
                    \textbf{pMOS} ($V_{SG,p} = V_S - V_G$, $V_{SD,p} = V_S - V_D$):

                    \quad Sat: $I_p = \frac{|K_p|}{2}(V_{SG,p} - |V_{Tp}|)^2$

                    \quad Ohm: $I_p = |K_p|\left[(V_{SG,p} - |V_{Tp}|)V_{SD,p} - \frac{V_{SD,p}^2}{2}\right]$
        ...
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \colorbox{orange!25}{\parbox{0.95\linewidth}{
                    ...
                    $$\frac{|K_p|}{2}(V_{DD} - |V_T|)^2 = K_{n,eq}\left[(V_{GS,n} - V_T)V_{OL} - \frac{V_{OL}^2}{2}\right]$$
                }}
                ...
                \colorbox{violet!15}{\parbox{0.95\linewidth}{
                    ...
                    \vspace{0.1cm}
                    Riarrangiando: $\frac{K_{n,eq}}{2}V_{OL}^2 - K_{n,eq}(V_{GS,n}-V_T)V_{OL} + I_{sat,p} = 0$
                ...
                \colorbox{violet!15}{\parbox{0.95\linewidth}{
                    ...
                    \quad $R_{DS,on,n} = \frac{1}{K_n(V_{GS,n} - V_{Tn})}$

                    \quad $I_{sat,p} = \frac{|K_p|}{2}(V_{SG,p} - |V_{Tp}|)^2$

                    $$\boxed{V_{OL} \approx I_{sat,p} \cdot R_{DS,on,n_{eq}}}$$

                    \textbf{Caso B --- Uscita alta} (pMOS in ohmica):

                    \quad $R_{DS,on,p} = \frac{1}{|K_p|(V_{SG,p} - |V_{Tp}|)}$

                    \quad $I_{sat,n} = \frac{K_n}{2}(V_{GS,n} - V_{Tn})^2$
                    ...
                    \textbf{Contro:} Approssimazione (trascura $V_{DS}^2/2$).
        ...
        \node [mybox] (box){%
            \begin{minipage}{0.3\textwidth}
                ...
                \colorbox{yellow!30}{\parbox{0.95\linewidth}{
                    ...
                    Quindi: $\quad R_{DS,on} = \frac{V_{DS}}{I_{DS}} = \frac{1}{K(V_{GS} - V_T)}$
                }}
                ...
                \colorbox{cyan!20}{\parbox{0.95\linewidth}{
                    ...
                    $$R_{DS,on,n} = \frac{1}{K_n(V_{GS,n} - V_{Tn})}$$

                    \textbf{pMOS:}

                    $$R_{DS,on,p} = \frac{1}{|K_p|(V_{SG,p} - |V_{Tp}|)}$$
                ...
                \vspace{0.15cm}
                \colorbox{orange!25}{\parbox{0.95\linewidth}{\footnotesize
                    \textbf{$\triangle$ ATTENZIONE ai $V_{GS}$/$V_{SG}$:}

                    \vspace{0.05cm}
                    • nMOS: $V_{GS,n}$ = tensione gate $-$ tensione source dell'nMOS

                    \quad (source = GND se è il MOS più in basso della serie)

                    • pMOS: $V_{SG,p}$ = tensione source $-$ tensione gate del pMOS

                    \quad (source = $V_{DD}$ se è il MOS più in alto della serie)

                    \vspace{0.05cm}
                    \textit{Caso tipico:} gate a $V_{DD}$ (nMOS) o a GND (pMOS):

                    \quad $V_{GS,n} = V_{DD}$, \quad $V_{SG,p} = V_{DD}$
                }}
